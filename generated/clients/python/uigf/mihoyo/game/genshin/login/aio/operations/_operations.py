...
class PandaQrApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.mihoyo.passport.aio.LoginClient`'s
    ...
    async def create(
        ...
        :param body: Required.
        :type body: ~uigf.mihoyo.game.types.PandaQrRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ApiResponsePandaQrResponse. The ApiResponsePandaQrResponse is compatible with
    ...
    async def create(
        ...
        :type body: ~uigf.mihoyo.game.models.PandaQrRequest or ~uigf.mihoyo.game.types.PandaQrRequest
         or IO[bytes]
        :return: ApiResponsePandaQrResponse. The ApiResponsePandaQrResponse is compatible with
         MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponsePandaQrResponse
...
class GranterApiOperations:  # pylint: disable=docstring-missing-param
    ...
    async def login(
        ...
        **kwargs: Any
    ) -> _models5.ApiResponseGranterLoginData:
        """Submits the caller-provided official granter login payload.

        :param body: Required.
        :type body: ~uigf.mihoyo.game.genshin.sdk.models.GranterLoginRequest
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ApiResponseGranterLoginData. The ApiResponseGranterLoginData is compatible with
         MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponseGranterLoginData
        :raises ~corehttp.exceptions.HttpResponseError:
        """
    ...
    async def login(
        ...
        **kwargs: Any
        ...
        :param body: Required.
        :type body: ~uigf.mihoyo.game.genshin.sdk.types.GranterLoginRequest
        :keyword rpc_app_id: Default value is None.
        :paramtype rpc_app_id: str
        :keyword rpc_app_version: Default value is None.
        :paramtype rpc_app_version: str
    ...
    async def login(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        :type body: ~uigf.mihoyo.game.genshin.sdk.models.GranterLoginRequest or
         ~uigf.mihoyo.game.genshin.sdk.types.GranterLoginRequest or IO[bytes]
        :keyword rpc_app_id: Default value is None.
        :paramtype rpc_app_id: str
        :keyword rpc_app_version: Default value is None.
        :paramtype rpc_app_version: str
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models5.ApiResponseGranterLoginData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models5.ApiResponseGranterLoginData, response.json())
