...
class GranterApiOperations:  # pylint: disable=docstring-missing-param
    ...
    def login(
        ...
        **kwargs: Any
    ) -> _models4.ApiResponseGranterLoginData:
    ...
    def login(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models4.ApiResponseGranterLoginData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models4.ApiResponseGranterLoginData, response.json())
