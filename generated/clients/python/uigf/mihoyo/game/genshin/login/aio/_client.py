...
class LoginClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype panda_qr_api: uigf.mihoyo.passport.aio.operations.PandaQrApiOperations
    :ivar granter_api: GranterApiOperations operations
    :vartype granter_api: uigf.mihoyo.passport.aio.operations.GranterApiOperations
