...
class AnnouncementApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.mihoyo.passport.AnnouncementsClient`'s
    ...
    def list(
        ...
        *,
        ...
        channel_id: Optional[int] = None,
        **kwargs: Any
    ) -> _models4.ApiResponseAnnouncementListData:
        """list.
        ...
        cls: ClsType[_models4.ApiResponseAnnouncementListData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models4.ApiResponseAnnouncementListData, response.json())
    ...
    def get_alert(
        ...
        *,
        ...
        channel_id: Optional[int] = None,
        **kwargs: Any
    ) -> _models4.ApiResponseAnnouncementAlertData:
        """get_alert.
        ...
        cls: ClsType[_models4.ApiResponseAnnouncementAlertData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models4.ApiResponseAnnouncementAlertData, response.json())
    ...
    def get_alert_picture(
        ...
        *,
        ...
        channel_id: Optional[int] = None,
        **kwargs: Any
    ) -> _models4.ApiResponseAnnouncementPictureData:
        """get_alert_picture.
        ...
        cls: ClsType[_models4.ApiResponseAnnouncementPictureData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models4.ApiResponseAnnouncementPictureData, response.json())
