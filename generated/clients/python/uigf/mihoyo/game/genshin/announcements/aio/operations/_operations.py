...
class AnnouncementApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.mihoyo.passport.aio.AnnouncementsClient`'s
    ...
    async def list(
        ...
        **kwargs: Any
    ) -> _models5.ApiResponseAnnouncementListData:
        """list.
        ...
        :return: ApiResponseAnnouncementListData. The ApiResponseAnnouncementListData is compatible
         with MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponseAnnouncementListData
        ...
        cls: ClsType[_models5.ApiResponseAnnouncementListData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models5.ApiResponseAnnouncementListData, response.json())
    ...
    async def get_alert(
        ...
        *,
        ...
        channel_id: Optional[int] = None,
        **kwargs: Any
    ) -> _models5.ApiResponseAnnouncementAlertData:
        """get_alert.
        ...
        :keyword channel_id: Default value is None.
        :paramtype channel_id: int
        :return: ApiResponseAnnouncementAlertData. The ApiResponseAnnouncementAlertData is compatible
         with MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponseAnnouncementAlertData
        :raises ~corehttp.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_models5.ApiResponseAnnouncementAlertData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models5.ApiResponseAnnouncementAlertData, response.json())
    ...
    async def get_alert_picture(
        ...
        *,
        ...
        channel_id: Optional[int] = None,
        **kwargs: Any
    ) -> _models5.ApiResponseAnnouncementPictureData:
        """get_alert_picture.
        ...
        :keyword channel_id: Default value is None.
        :paramtype channel_id: int
        :return: ApiResponseAnnouncementPictureData. The ApiResponseAnnouncementPictureData is
         compatible with MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponseAnnouncementPictureData
        :raises ~corehttp.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_models5.ApiResponseAnnouncementPictureData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models5.ApiResponseAnnouncementPictureData, response.json())
