...
class ContentApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.mihoyo.passport.AnnouncementContentClient`'s
    ...
    def get(
        ...
        *,
        ...
        channel_id: Optional[int] = None,
        **kwargs: Any
    ) -> _models4.ApiResponseAnnouncementContentData:
        """get.
        ...
        cls: ClsType[_models4.ApiResponseAnnouncementContentData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models4.ApiResponseAnnouncementContentData, response.json())
