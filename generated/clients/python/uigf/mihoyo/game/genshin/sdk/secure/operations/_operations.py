...
class SecureApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.mihoyo.passport.SecureClient`'s
    ...
    def compare_protocol_version(
        ...
        **kwargs: Any
    ) -> _models5.ApiResponseSdkProtocolVersionComparisonData:
    ...
    def compare_protocol_version(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models5.ApiResponseSdkProtocolVersionComparisonData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models5.ApiResponseSdkProtocolVersionComparisonData, response.json())
    ...
    def get_red_dots(
        ...
        *,
        ...
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models5.ApiResponseSdkRedDotData:
        """get_red_dots.
    ...
    def get_red_dots(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models5.ApiResponseSdkRedDotData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models5.ApiResponseSdkRedDotData, response.json())
