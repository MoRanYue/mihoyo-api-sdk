...
class SecureApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.mihoyo.passport.aio.SecureClient`'s
    ...
    async def compare_protocol_version(
        ...
        **kwargs: Any
    ) -> _models6.ApiResponseSdkProtocolVersionComparisonData:
        """compare_protocol_version.

        :param body: Required.
        :type body: ~uigf.mihoyo.game.genshin.sdk.models.ProtocolVersionRequest
        ...
        :return: ApiResponseSdkProtocolVersionComparisonData. The
         ApiResponseSdkProtocolVersionComparisonData is compatible with MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponseSdkProtocolVersionComparisonData
    ...
    async def compare_protocol_version(
        ...
        **kwargs: Any
        ...
        :param body: Required.
        :type body: ~uigf.mihoyo.game.genshin.sdk.types.ProtocolVersionRequest
        :keyword rpc_app_id: Default value is None.
        :paramtype rpc_app_id: str
        :keyword rpc_app_version: Default value is None.
        :paramtype rpc_app_version: str
    ...
    async def compare_protocol_version(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        :type body: ~uigf.mihoyo.game.genshin.sdk.models.ProtocolVersionRequest or
         ~uigf.mihoyo.game.genshin.sdk.types.ProtocolVersionRequest or IO[bytes]
        :keyword rpc_app_id: Default value is None.
        :paramtype rpc_app_id: str
        :keyword rpc_app_version: Default value is None.
        :paramtype rpc_app_version: str
        ...
        cls: ClsType[_models6.ApiResponseSdkProtocolVersionComparisonData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models6.ApiResponseSdkProtocolVersionComparisonData, response.json())
    ...
    async def get_red_dots(
        ...
        *,
        ...
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models6.ApiResponseSdkRedDotData:
        """get_red_dots.

        :param body: Required.
        :type body: ~uigf.mihoyo.game.genshin.sdk.models.RedDotRequest
        :keyword rpc_app_id: Default value is None.
        :paramtype rpc_app_id: str
        :keyword rpc_app_version: Default value is None.
        :paramtype rpc_app_version: str
        ...
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ApiResponseSdkRedDotData. The ApiResponseSdkRedDotData is compatible with
         MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponseSdkRedDotData
        :raises ~corehttp.exceptions.HttpResponseError:
        """
    ...
    async def get_red_dots(
        ...
        **kwargs: Any
        ...
        :param body: Required.
        :type body: ~uigf.mihoyo.game.genshin.sdk.types.RedDotRequest
        :keyword rpc_app_id: Default value is None.
        :paramtype rpc_app_id: str
        :keyword rpc_app_version: Default value is None.
        :paramtype rpc_app_version: str
    ...
    async def get_red_dots(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
        ...
        :type body: ~uigf.mihoyo.game.genshin.sdk.models.RedDotRequest or
         ~uigf.mihoyo.game.genshin.sdk.types.RedDotRequest or IO[bytes]
        :keyword rpc_app_id: Default value is None.
        :paramtype rpc_app_id: str
        :keyword rpc_app_version: Default value is None.
        :paramtype rpc_app_version: str
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models6.ApiResponseSdkRedDotData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models6.ApiResponseSdkRedDotData, response.json())
