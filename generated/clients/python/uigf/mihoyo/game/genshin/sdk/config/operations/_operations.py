...
class ConfigApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.mihoyo.passport.ConfigClient`'s
    ...
    def get_combo(  # pylint: disable=too-many-locals
        ...
        *,
        ...
        rpc_system_version: Optional[str] = None,
        **kwargs: Any
    ) -> _models5.ApiResponseSdkComboConfigData:
        """get_combo.
        ...
        cls: ClsType[_models5.ApiResponseSdkComboConfigData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models5.ApiResponseSdkComboConfigData, response.json())
    ...
    def get_precache(  # pylint: disable=too-many-locals
        ...
        *,
        ...
        rpc_system_version: Optional[str] = None,
        **kwargs: Any
    ) -> _models5.ApiResponseSdkPrecacheConfigData:
        """get_precache.
        ...
        cls: ClsType[_models5.ApiResponseSdkPrecacheConfigData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models5.ApiResponseSdkPrecacheConfigData, response.json())
    ...
    def get_granter_config(  # pylint: disable=too-many-locals
        ...
        *,
        ...
        rpc_system_version: Optional[str] = None,
        **kwargs: Any
    ) -> _models5.ApiResponseSdkGranterConfigData:
        """get_granter_config.
        ...
        cls: ClsType[_models5.ApiResponseSdkGranterConfigData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models5.ApiResponseSdkGranterConfigData, response.json())
    ...
    def get_shield_config(  # pylint: disable=too-many-locals
        ...
        *,
        ...
        rpc_system_version: Optional[str] = None,
        **kwargs: Any
    ) -> _models5.ApiResponseSdkShieldConfigData:
        """get_shield_config.
        ...
        cls: ClsType[_models5.ApiResponseSdkShieldConfigData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models5.ApiResponseSdkShieldConfigData, response.json())
