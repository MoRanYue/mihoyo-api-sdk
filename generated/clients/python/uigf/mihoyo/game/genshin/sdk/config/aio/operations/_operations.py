...
class ConfigApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.mihoyo.passport.aio.ConfigClient`'s
    ...
    async def get_combo(  # pylint: disable=too-many-locals
        ...
        **kwargs: Any
    ) -> _models6.ApiResponseSdkComboConfigData:
        """get_combo.
        ...
        :return: ApiResponseSdkComboConfigData. The ApiResponseSdkComboConfigData is compatible with
         MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponseSdkComboConfigData
        ...
        cls: ClsType[_models6.ApiResponseSdkComboConfigData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models6.ApiResponseSdkComboConfigData, response.json())
    ...
    async def get_precache(  # pylint: disable=too-many-locals
        ...
        *,
        ...
        rpc_system_version: Optional[str] = None,
        **kwargs: Any
    ) -> _models6.ApiResponseSdkPrecacheConfigData:
        """get_precache.
        ...
        :keyword rpc_system_version: Default value is None.
        :paramtype rpc_system_version: str
        :return: ApiResponseSdkPrecacheConfigData. The ApiResponseSdkPrecacheConfigData is compatible
         with MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponseSdkPrecacheConfigData
        :raises ~corehttp.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_models6.ApiResponseSdkPrecacheConfigData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models6.ApiResponseSdkPrecacheConfigData, response.json())
    ...
    async def get_granter_config(  # pylint: disable=too-many-locals
        ...
        *,
        ...
        rpc_system_version: Optional[str] = None,
        **kwargs: Any
    ) -> _models6.ApiResponseSdkGranterConfigData:
        """get_granter_config.
        ...
        :keyword rpc_system_version: Default value is None.
        :paramtype rpc_system_version: str
        :return: ApiResponseSdkGranterConfigData. The ApiResponseSdkGranterConfigData is compatible
         with MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponseSdkGranterConfigData
        :raises ~corehttp.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_models6.ApiResponseSdkGranterConfigData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models6.ApiResponseSdkGranterConfigData, response.json())
    ...
    async def get_shield_config(  # pylint: disable=too-many-locals
        ...
        *,
        ...
        rpc_system_version: Optional[str] = None,
        **kwargs: Any
    ) -> _models6.ApiResponseSdkShieldConfigData:
        """get_shield_config.
        ...
        :keyword rpc_system_version: Default value is None.
        :paramtype rpc_system_version: str
        :return: ApiResponseSdkShieldConfigData. The ApiResponseSdkShieldConfigData is compatible with
         MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponseSdkShieldConfigData
        :raises ~corehttp.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_models6.ApiResponseSdkShieldConfigData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models6.ApiResponseSdkShieldConfigData, response.json())
