...
def build_legacy_card_api_get_game_record_card_request(  # pylint: disable=name-too-long
    *, cookie: str, uid: str, ds: Optional[str] = None, **kwargs: Any
    ...
    # Construct URL
    _url = "/game_record/card/api/getGameRecordCard"
...
def build_web_card_api_get_game_record_card_request(  # pylint: disable=name-too-long
    *, uid: str, cookie: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/game_record/card/wapi/getGameRecordCard"
...
class LegacyCardApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.mihoyo.passport.LegacyRecordClient`'s
