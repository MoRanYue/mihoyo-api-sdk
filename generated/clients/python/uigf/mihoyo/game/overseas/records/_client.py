...
class GlobalGameRecordsClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype game_record_api: uigf.mihoyo.passport.operations.GameRecordApiOperations
    :ivar zenless_game_record_api: ZenlessGameRecordApiOperations operations
    :vartype zenless_game_record_api:
     uigf.mihoyo.passport.operations.ZenlessGameRecordApiOperations
    :ivar zenless_cultivation_api: ZenlessCultivationApiOperations operations
    :vartype zenless_cultivation_api:
     uigf.mihoyo.passport.operations.ZenlessCultivationApiOperations
    :ivar star_rail_ledger_api: StarRailLedgerApiOperations operations
    :vartype star_rail_ledger_api: uigf.mihoyo.passport.operations.StarRailLedgerApiOperations
    :ivar zenless_ledger_api: ZenlessLedgerApiOperations operations
    :vartype zenless_ledger_api: uigf.mihoyo.passport.operations.ZenlessLedgerApiOperations
