...
def build_zenless_api_get_shiyu_defense_request(  # pylint: disable=name-too-long
    ...
    **kwargs: Any
    ...
    # Construct parameters
    if without_v2_detail is not None:
        _params["without_v2_detail"] = _SERIALIZER.query("without_v2_detail", without_v2_detail, "bool")
    if schedule_type is not None:
        _params["schedule_type"] = _SERIALIZER.query("schedule_type", schedule_type, "int")
    if need_detail is not None:
        _params["need_detail"] = _SERIALIZER.query("need_detail", need_detail, "bool")
...
def build_zenless_mobile_api_get_abyss_summary_request(  # pylint: disable=name-too-long
    *, role_id: str, server: str, cookie: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/event/game_record_zzz/api/zzz/abyss_abstract"
...
def build_zenless_mobile_api_get_abyss_season_two_summary_request(  # pylint: disable=name-too-long
    *, region: str, uid: int, cookie: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/event/game_record_zzz/api/zzz/abysss2_abstract"
...
def build_zenless_mobile_api_get_activity_calendar_request(  # pylint: disable=name-too-long
    *, region: str, uid: int, cookie: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/event/game_record_zzz/api/zzz/activity_calendar"
...
def build_zenless_mobile_api_get_climbing_tower_detail_request(  # pylint: disable=name-too-long
    *, region: str, uid: int, cookie: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/event/game_record_zzz/api/zzz/climbing_tower_detail"
...
def build_zenless_mobile_api_get_exploration_detail_request(  # pylint: disable=name-too-long
    *, region: str, uid: int, cookie: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/event/game_record_zzz/api/zzz/exploration_detail"
...
def build_zenless_mobile_api_get_gacha_calendar_request(  # pylint: disable=name-too-long
    *, region: str, uid: int, cookie: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/event/game_record_zzz/api/zzz/gacha_calendar"
...
def build_zenless_mobile_api_get_deadly_assault_summary_request(  # pylint: disable=name-too-long
    *, region: str, schedule_type: int, uid: int, cookie: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/event/game_record_zzz/api/zzz/hadal_mem_abstract_info"
...
def build_zenless_mobile_api_get_threshold_simulation_period_summary_request(  # pylint: disable=name-too-long
    *, region: str, schedule_type: int, uid: int, cookie: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
    _params = case_insensitive_dict(kwargs.pop("params", {}) or {})
    ...
    # Construct URL
    _url = "/event/game_record_zzz/api/zzz/void_front_battle_period_abstract_info"
...
class HonkaiImpactApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.mihoyo.passport.CnGameRecordsClient`'s
...
class ZenlessApiOperations:  # pylint: disable=docstring-missing-param
    ...
    def get_index(
        self, *, cookie: str, server: str, role_id: str, ds: Optional[str] = None, **kwargs: Any
    ) -> _models4.ApiResponseZenlessIndexData:
        """get_index.
        ...
        cls: ClsType[_models4.ApiResponseZenlessIndexData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models4.ApiResponseZenlessIndexData, response.json())
    ...
    def get_daily_note(
    ...
    ) -> _models4.ApiResponseZenlessDailyNoteData:
        """get_daily_note.
        ...
        cls: ClsType[_models4.ApiResponseZenlessDailyNoteData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models4.ApiResponseZenlessDailyNoteData, response.json())
    ...
    def get_shiyu_defense(
        ...
        *,
        ...
        need_all: Optional[bool] = None,
        **kwargs: Any
    ) -> _models4.ApiResponseZenlessShiyuDefenseData:
        """get_shiyu_defense.
        ...
        cls: ClsType[_models4.ApiResponseZenlessShiyuDefenseData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models4.ApiResponseZenlessShiyuDefenseData, response.json())
...
class ZenlessMobileApiOperations:  # pylint: disable=docstring-missing-param
    ...
    def get_abyss_summary(
        self, *, role_id: str, server: str, cookie: Optional[str] = None, **kwargs: Any
    ) -> _models4.ApiResponseZenlessAbyssSummaryData:
        """get_abyss_summary.
        ...
        cls: ClsType[_models4.ApiResponseZenlessAbyssSummaryData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models4.ApiResponseZenlessAbyssSummaryData, response.json())
    ...
    def get_abyss_season_two_summary(
        self, *, region: str, uid: int, cookie: Optional[str] = None, **kwargs: Any
    ) -> _models4.ApiResponseZenlessAbyssSeasonTwoSummaryData:
        ...
        cls: ClsType[_models4.ApiResponseZenlessAbyssSeasonTwoSummaryData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models4.ApiResponseZenlessAbyssSeasonTwoSummaryData, response.json())
    ...
    def get_activity_calendar(
        self, *, region: str, uid: int, cookie: Optional[str] = None, **kwargs: Any
    ) -> _models4.ApiResponseZenlessActivityCalendarData:
        ...
        cls: ClsType[_models4.ApiResponseZenlessActivityCalendarData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models4.ApiResponseZenlessActivityCalendarData, response.json())
    ...
    def get_climbing_tower_detail(
        self, *, region: str, uid: int, cookie: Optional[str] = None, **kwargs: Any
    ) -> _models4.ApiResponseZenlessClimbingTowerDetailData:
        ...
        cls: ClsType[_models4.ApiResponseZenlessClimbingTowerDetailData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models4.ApiResponseZenlessClimbingTowerDetailData, response.json())
    ...
    def get_exploration_detail(
        self, *, region: str, uid: int, cookie: Optional[str] = None, **kwargs: Any
    ) -> _models4.ApiResponseZenlessExplorationDetailData:
        ...
        cls: ClsType[_models4.ApiResponseZenlessExplorationDetailData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models4.ApiResponseZenlessExplorationDetailData, response.json())
    ...
    def get_gacha_calendar(
        self, *, region: str, uid: int, cookie: Optional[str] = None, **kwargs: Any
    ) -> _models4.ApiResponseZenlessGachaCalendarData:
        """get_gacha_calendar.
        ...
        cls: ClsType[_models4.ApiResponseZenlessGachaCalendarData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models4.ApiResponseZenlessGachaCalendarData, response.json())
    ...
    def get_deadly_assault_summary(
        self, *, region: str, schedule_type: int, uid: int, cookie: Optional[str] = None, **kwargs: Any
    ) -> _models4.ApiResponseZenlessDeadlyAssaultSummaryData:
        ...
        cls: ClsType[_models4.ApiResponseZenlessDeadlyAssaultSummaryData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models4.ApiResponseZenlessDeadlyAssaultSummaryData, response.json())
    ...
    def get_threshold_simulation_period_summary(
        self, *, region: str, schedule_type: int, uid: int, cookie: Optional[str] = None, **kwargs: Any
    ) -> _models4.ApiResponseZenlessThresholdSimulationPeriodSummaryData:
        ...
        cls: ClsType[_models4.ApiResponseZenlessThresholdSimulationPeriodSummaryData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(
                _models4.ApiResponseZenlessThresholdSimulationPeriodSummaryData, response.json()
            )
