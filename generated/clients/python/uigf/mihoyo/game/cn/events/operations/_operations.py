...
class StarRailLedgerApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.mihoyo.passport.EventsClient`'s
...
class ZenlessLedgerApiOperations:  # pylint: disable=docstring-missing-param
    ...
    def get_month_info(
        ...
        *,
        ...
        lang: Optional[str] = None,
        **kwargs: Any
    ) -> _models4.ApiResponseZenlessLedgerMonthInfoData:
        """get_month_info.
        ...
        cls: ClsType[_models4.ApiResponseZenlessLedgerMonthInfoData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models4.ApiResponseZenlessLedgerMonthInfoData, response.json())
