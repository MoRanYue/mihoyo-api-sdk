...
class StarRailLedgerApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.mihoyo.passport.aio.EventsClient`'s
...
class ZenlessLedgerApiOperations:  # pylint: disable=docstring-missing-param
    ...
    async def get_month_info(
        ...
        *,
        ...
        lang: Optional[str] = None,
        **kwargs: Any
    ) -> _models5.ApiResponseZenlessLedgerMonthInfoData:
        """get_month_info.
        ...
        :keyword role_id: Default value is None.
        :paramtype role_id: str
        :keyword server: Default value is None.
        :paramtype server: str
        :keyword month: Default value is None.
        :paramtype month: str
        :keyword lang: Default value is None.
        :paramtype lang: str
        :return: ApiResponseZenlessLedgerMonthInfoData. The ApiResponseZenlessLedgerMonthInfoData is
         compatible with MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponseZenlessLedgerMonthInfoData
        :raises ~corehttp.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_models5.ApiResponseZenlessLedgerMonthInfoData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models5.ApiResponseZenlessLedgerMonthInfoData, response.json())
