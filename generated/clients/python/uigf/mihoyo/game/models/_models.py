...
class AuthKeyRequest(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    ...
    """Required."""
    game_uid: int = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Required."""
...
class CharacterListRequest(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    ...
    """Required."""
    sort_type: Optional[int] = rest_field(visibility=["read", "create", "update", "delete", "query"])
...
class CharacterDetailRequest(CharacterListRequest):  # pylint: disable=docstring-keyword-should-match-keyword-only
    ...
    :vartype character_ids: list[str or int]
    """

    character_ids: list[Union[str, int]] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    """Required."""
    ...
    def __init__(
        ...
        *,
        role_id: str,
        server: str,
        character_ids: list[Union[str, int]],
        sort_type: Optional[int] = None,
    ) -> None: ...
...
class CharacterList(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    ...
    :ivar list: Required.
    :vartype list: list[~uigf.mihoyo.game.models.Character]
    """
...
class DeviceFingerprintRequest(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    ...
    """Required."""
    bbs_device_id: Optional[str] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    ...
    def __init__(
        ...
        *,
        ...
        platform: str,
        seed_time: str,
        bbs_device_id: Optional[str] = None,
    ) -> None: ...
