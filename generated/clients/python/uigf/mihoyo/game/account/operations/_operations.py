...
def build_action_ticket_api_get_by_s_token_request(  # pylint: disable=name-too-long
    *, cookie: str, action_type: str, stoken: str, uid: str, ds: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    _headers = case_insensitive_dict(kwargs.pop("headers", {}) or {})
...
class GameTokenApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.mihoyo.passport.GameAccountClient`'s
...
class CultivationApiOperations:  # pylint: disable=docstring-missing-param
    ...
    def batch_compute(
        ...
        **kwargs: Any
        ...
        :type body: ~uigf.mihoyo.game.models.CalculateRequest or
