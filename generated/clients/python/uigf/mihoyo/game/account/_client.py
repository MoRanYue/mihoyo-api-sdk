...
class GameAccountClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype game_token_api: uigf.mihoyo.passport.operations.GameTokenApiOperations
    :ivar action_ticket_api: ActionTicketApiOperations operations
    :vartype action_ticket_api: uigf.mihoyo.passport.operations.ActionTicketApiOperations
    ...
    :vartype genshin_obc_api: uigf.mihoyo.passport.operations.GenshinObcApiOperations
    :ivar cultivation_api: CultivationApiOperations operations
    :vartype cultivation_api: uigf.mihoyo.passport.operations.CultivationApiOperations
