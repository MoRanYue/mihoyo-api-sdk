...
class GameAccountClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype game_token_api: uigf.mihoyo.passport.aio.operations.GameTokenApiOperations
    :ivar action_ticket_api: ActionTicketApiOperations operations
    :vartype action_ticket_api: uigf.mihoyo.passport.aio.operations.ActionTicketApiOperations
    ...
    :vartype genshin_obc_api: uigf.mihoyo.passport.aio.operations.GenshinObcApiOperations
    :ivar cultivation_api: CultivationApiOperations operations
    :vartype cultivation_api: uigf.mihoyo.passport.aio.operations.CultivationApiOperations
