...
class MetadataApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.mihoyo.passport.aio.GlobalLauncherClient`'s
    ...
    async def get_all_game_basic_info(
        ...
        :return: LauncherResponseGameBasicInfo. The LauncherResponseGameBasicInfo is compatible with
         MutableMapping
        :rtype: ~uigf.mihoyo.models.LauncherResponseGameBasicInfo
    ...
    async def get_game_packages(
        ...
        :return: LauncherResponseJsonObject. The LauncherResponseJsonObject is compatible with
         MutableMapping
        :rtype: ~uigf.mihoyo.models.LauncherResponseJsonObject
        :raises ~corehttp.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    async def get_dx_configs(
        ...
        **kwargs: Any
        ...
        :param body: Required.
        :type body: ~uigf.mihoyo.launcher.models.DxConfigRequest
        :keyword launcher_id: Required.
        :paramtype launcher_id: str
        :keyword language: Required.
        :paramtype language: str
    ...
    async def get_dx_configs(
        ...
        **kwargs: Any
        ...
        :param body: Required.
        :type body: ~uigf.mihoyo.launcher.types.DxConfigRequest
        :keyword launcher_id: Required.
        :paramtype launcher_id: str
        :keyword language: Required.
        :paramtype language: str
    ...
    async def get_dx_configs(
        ...
        **kwargs: Any
        ...
        :type body: ~uigf.mihoyo.launcher.models.DxConfigRequest or
         ~uigf.mihoyo.launcher.types.DxConfigRequest or IO[bytes]
        :keyword launcher_id: Required.
        :paramtype launcher_id: str
        :keyword language: Required.
        :paramtype language: str
