...
class ForumList(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    ...
    :ivar list:
    :vartype list: list[~uigf.mihoyo.community.models.Forum]
    """
...
class Post(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    ...
    :ivar user:
    :vartype user: ~uigf.mihoyo.models.CommunityUser
    :ivar images:
    :vartype images: list[~uigf.mihoyo.models.JsonObject]
    """
...
class PostList(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    ...
    :ivar list:
    :vartype list: list[~uigf.mihoyo.community.models.Post]
    :ivar is_last:
