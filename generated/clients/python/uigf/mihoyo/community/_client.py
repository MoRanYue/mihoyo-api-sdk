...
class CommunityClient:  # pylint: disable=client-accepts-api-version-keyword,too-many-instance-attributes
    ...
    :vartype user_api: uigf.mihoyo.passport.operations.UserApiOperations
    :ivar misc_api: MiscApiOperations operations
    :vartype misc_api: uigf.mihoyo.passport.operations.MiscApiOperations
    :ivar collection_api: CollectionApiOperations operations
    :vartype collection_api: uigf.mihoyo.passport.operations.CollectionApiOperations
    :ivar coin_record_api: CoinRecordApiOperations operations
    :vartype coin_record_api: uigf.mihoyo.passport.operations.CoinRecordApiOperations
    :ivar post_api: PostApiOperations operations
    :vartype post_api: uigf.mihoyo.passport.operations.PostApiOperations
    :ivar feed_api: FeedApiOperations operations
    :vartype feed_api: uigf.mihoyo.passport.operations.FeedApiOperations
    :ivar topic_api: TopicApiOperations operations
    :vartype topic_api: uigf.mihoyo.passport.operations.TopicApiOperations
    :ivar api_hub: ApiHubOperations operations
    :vartype api_hub: uigf.mihoyo.passport.operations.ApiHubOperations
