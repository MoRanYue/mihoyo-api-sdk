...
class UserApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.mihoyo.passport.aio.CommunityClient`'s
...
class ApiHubOperations:  # pylint: disable=docstring-missing-param
    ...
    async def get_app_config(
        self, *, gid: Optional[str] = None, **kwargs: Any
    ) -> _models3.ApiResponseCommunityAppConfigData:
        """get_app_config.
        ...
        cls: ClsType[_models3.ApiResponseCommunityAppConfigData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models3.ApiResponseCommunityAppConfigData, response.json())
    ...
    async def get_home(
        ...
        **kwargs: Any
    ) -> _models3.ApiResponseCommunityHomeData:
        """get_home.
        ...
        cls: ClsType[_models3.ApiResponseCommunityHomeData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models3.ApiResponseCommunityHomeData, response.json())
