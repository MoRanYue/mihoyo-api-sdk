...
def build_api_hub_get_home_request(
    *,
    gids: int,
    cpu: Optional[str] = None,
    device: Optional[str] = None,
    exposed_resource_tickets: Optional[str] = None,
    is_triggered_by_resource: Optional[bool] = None,
    ...
    **kwargs: Any
    ...
    if exposed_resource_tickets is not None:
        _params["exposed_resource_tickets"] = _SERIALIZER.query(
            "exposed_resource_tickets", exposed_resource_tickets, "str"
        )
    if is_triggered_by_resource is not None:
        _params["is_triggered_by_resource"] = _SERIALIZER.query(
            "is_triggered_by_resource", is_triggered_by_resource, "bool"
        )
    if parts is not None:
        _params["parts"] = _SERIALIZER.query("parts", parts, "str")
...
class UserApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.mihoyo.passport.CommunityClient`'s
...
class MiscApiOperations:  # pylint: disable=docstring-missing-param
    ...
    def create_verification(
        ...
        **kwargs: Any
        ...
        :param body: Required.
        :type body: ~uigf.mihoyo.community.models.VerificationCreateRequest
    ...
    def create_verification(
        ...
        **kwargs: Any
        ...
        :param body: Required.
        :type body: ~uigf.mihoyo.community.types.VerificationCreateRequest
        :keyword cookie: Required.
        :paramtype cookie: str
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
    ...
    def create_verification(
        ...
        **kwargs: Any
        ...
        :type body: ~uigf.mihoyo.community.models.VerificationCreateRequest or
         ~uigf.mihoyo.community.types.VerificationCreateRequest or IO[bytes]
        :keyword cookie: Required.
        :paramtype cookie: str
        :return: ApiResponseJsonObject. The ApiResponseJsonObject is compatible with MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponseJsonObject
    ...
    def verify_verification(
        ...
        **kwargs: Any
        ...
        :param body: Required.
        :type body: ~uigf.mihoyo.community.models.VerificationSubmitRequest
        :keyword cookie: Required.
        :paramtype cookie: str
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
    ...
    def verify_verification(
        ...
        **kwargs: Any
        ...
        :param body: Required.
        :type body: ~uigf.mihoyo.community.types.VerificationSubmitRequest
        :keyword cookie: Required.
        :paramtype cookie: str
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
    ...
    def verify_verification(
        ...
        **kwargs: Any
        ...
        :type body: ~uigf.mihoyo.community.models.VerificationSubmitRequest or
         ~uigf.mihoyo.community.types.VerificationSubmitRequest or IO[bytes]
        :keyword cookie: Required.
        :paramtype cookie: str
        :return: ApiResponseJsonObject. The ApiResponseJsonObject is compatible with MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponseJsonObject
...
class PostApiOperations:  # pylint: disable=docstring-missing-param
    ...
    def get_full(
        ...
        **kwargs: Any
        ...
        :rtype: ~uigf.mihoyo.models.ApiResponsePost
        :raises ~corehttp.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def get_replies(
        ...
        **kwargs: Any
        ...
        :rtype: ~uigf.mihoyo.models.ApiResponsePostList
        :raises ~corehttp.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def set_favorite(
        ...
        **kwargs: Any
        ...
        :type body: ~uigf.mihoyo.community.models.FavoritePostRequest or
...
class ApiHubOperations:  # pylint: disable=docstring-missing-param
    ...
    def get_all_games_forums(self, **kwargs: Any) -> _models2.ApiResponseForumList:
        ...
        :rtype: ~uigf.mihoyo.models.ApiResponseForumList
        :raises ~corehttp.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
    ...
    def get_app_config(self, *, gid: Optional[str] = None, **kwargs: Any) -> _models2.ApiResponseCommunityAppConfigData:
        """get_app_config.

        :keyword gid: Default value is None.
        :paramtype gid: str
        :return: ApiResponseCommunityAppConfigData. The ApiResponseCommunityAppConfigData is compatible
         with MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponseCommunityAppConfigData
        :raises ~corehttp.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_models2.ApiResponseCommunityAppConfigData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models2.ApiResponseCommunityAppConfigData, response.json())
    ...
    def get_home(
        ...
        *,
        ...
        version: Optional[str] = None,
        **kwargs: Any
    ) -> _models2.ApiResponseCommunityHomeData:
        """get_home.

        :keyword gids: Required.
        :paramtype gids: int
        :keyword cpu: Default value is None.
        :paramtype cpu: str
        :keyword device: Default value is None.
        :paramtype device: str
        :keyword exposed_resource_tickets: Default value is None.
        :paramtype exposed_resource_tickets: str
        :keyword is_triggered_by_resource: Default value is None.
        :paramtype is_triggered_by_resource: bool
        :keyword parts: Default value is None.
        :paramtype parts: str
        :keyword version: Default value is None.
        :paramtype version: str
        :return: ApiResponseCommunityHomeData. The ApiResponseCommunityHomeData is compatible with
         MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponseCommunityHomeData
        :raises ~corehttp.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_models2.ApiResponseCommunityHomeData] = kwargs.pop("cls", None)

        _request = build_api_hub_get_home_request(
            gids=gids,
            cpu=cpu,
            device=device,
            exposed_resource_tickets=exposed_resource_tickets,
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models2.ApiResponseCommunityHomeData, response.json())
    ...
    def sign_in(
        ...
        **kwargs: Any
        ...
        :type body: ~uigf.mihoyo.community.models.SignInRequest or
    ...
    def set_post_vote(
        ...
        **kwargs: Any
        ...
        :type body: ~uigf.mihoyo.community.models.LikePostRequest or
