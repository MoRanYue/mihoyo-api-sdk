...
def build_fingerprint_api_get_extension_list_request(  # pylint: disable=name-too-long
    *, platform: str, app_name: Optional[str] = None, **kwargs: Any
) -> HttpRequest:
    ...
    if app_name is not None:
        _params["app_name"] = _SERIALIZER.query("app_name", app_name, "str")
...
class FingerprintApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.mihoyo.passport.DeviceClient`'s
    ...
    def get_extension_list(
        self, *, platform: str, app_name: Optional[str] = None, **kwargs: Any
    ) -> _models3.ApiResponseDeviceExtensionList:
    ...
    def get_fingerprint(
        ...
        **kwargs: Any
        ...
        :param body: Required.
        :type body: ~uigf.mihoyo.game.models.DeviceFingerprintRequest
        ...
        :return: ApiResponseDeviceFingerprint. The ApiResponseDeviceFingerprint is compatible with
         MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponseDeviceFingerprint
        :raises ~corehttp.exceptions.HttpResponseError:
        """
    ...
    def get_fingerprint(
        ...
        **kwargs: Any
        ...
        :param body: Required.
        :type body: ~uigf.mihoyo.game.types.DeviceFingerprintRequest
        :keyword app_version: Required.
        :paramtype app_version: str
        :keyword client_type: Required.
        :paramtype client_type: str
    ...
    def get_fingerprint(
        ...
        **kwargs: Any
        ...
        :type body: ~uigf.mihoyo.game.models.DeviceFingerprintRequest or
         ~uigf.mihoyo.game.types.DeviceFingerprintRequest or IO[bytes]
        :keyword app_version: Required.
        :paramtype app_version: str
        :keyword client_type: Required.
        :paramtype client_type: str
