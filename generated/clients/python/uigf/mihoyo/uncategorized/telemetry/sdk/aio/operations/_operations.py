...
class UploadApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.mihoyo.passport.aio.SDKClient`'s
    ...
    async def upload(
        self,
        body: List[_api_request_models7.SdkTelemetryUploadEvent],
        *,
        ...
        **kwargs: Any
        ...
        :param body: Required.
        :type body: list[~uigf.mihoyo.api.request.models.SdkTelemetryUploadEvent]
    ...
    async def upload(
        self,
        body: List[_types_api_request_models7.SdkTelemetryUploadEvent],
        *,
        authorization: Optional[str] = None,
        content_md5: Optional[str] = None,
        date: Optional[str] = None,
        ...
        **kwargs: Any
        ...
        :param body: Required.
        :type body: list[~uigf.mihoyo.api.request.types.SdkTelemetryUploadEvent]
        :keyword authorization: Default value is None.
        :paramtype authorization: str
        :keyword content_md5: Default value is None.
        :paramtype content_md5: str
    ...
    async def upload(
        self,
        body: Union[
            List[_api_request_models7.SdkTelemetryUploadEvent],
            List[_types_api_request_models7.SdkTelemetryUploadEvent],
            IO[bytes],
        ],
        *,
        authorization: Optional[str] = None,
        ...
        **kwargs: Any
        ...
        :param body: Is either a [SdkTelemetryUploadEvent] type or a IO[bytes] type. Required.
        :type body: list[~uigf.mihoyo.api.request.models.SdkTelemetryUploadEvent] or
         list[~uigf.mihoyo.api.request.types.SdkTelemetryUploadEvent] or IO[bytes]
        :keyword authorization: Default value is None.
        :paramtype authorization: str
        :keyword content_md5: Default value is None.
        :paramtype content_md5: str
