...
class UploadApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.mihoyo.passport.SDKClient`'s
    ...
    def upload(
        self,
        body: List[_api_request_models6.SdkTelemetryUploadEvent],
        *,
        authorization: Optional[str] = None,
        content_md5: Optional[str] = None,
        date: Optional[str] = None,
    ...
    def upload(
        self,
        body: List[_types_api_request_models6.SdkTelemetryUploadEvent],
        *,
        authorization: Optional[str] = None,
        content_md5: Optional[str] = None,
        date: Optional[str] = None,
    ...
    def upload(
        self,
        body: Union[
            List[_api_request_models6.SdkTelemetryUploadEvent],
            List[_types_api_request_models6.SdkTelemetryUploadEvent],
            IO[bytes],
        ],
        *,
        authorization: Optional[str] = None,
