...
class UploadApiOperations:  # pylint: disable=docstring-missing-param
    ...
    async def upload(
        self,
        body: _api_request_models7.CommunityTelemetryUploadRequest,
        *,
    ...
    async def upload(
        self,
        body: _types_api_request_models7.CommunityTelemetryUploadRequest,
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models4.UploadResponse:
    ...
    async def upload(
        self,
        body: Union[
            _api_request_models7.CommunityTelemetryUploadRequest,
            _types_api_request_models7.CommunityTelemetryUploadRequest,
            IO[bytes],
        ],
        **kwargs: Any
    ) -> _models4.UploadResponse:
