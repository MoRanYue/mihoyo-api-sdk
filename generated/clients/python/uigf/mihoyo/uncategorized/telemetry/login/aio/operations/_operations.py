...
class UploadApiOperations:  # pylint: disable=docstring-missing-param
    ...
    async def upload(
        self,
        body: List[_api_request_models7.LoginTelemetryEvent],
        *,
        authorization: str,
    ...
    async def upload(
        self,
        body: List[_types_api_request_models7.LoginTelemetryEvent],
        *,
        authorization: str,
        content_type: str = "application/json",
        **kwargs: Any
    ...
    async def upload(
        self,
        body: Union[
            List[_api_request_models7.LoginTelemetryEvent],
            List[_types_api_request_models7.LoginTelemetryEvent],
            IO[bytes],
        ],
        *,
        authorization: str,
