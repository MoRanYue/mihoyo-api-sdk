...
class TokenApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.mihoyo.passport.UGCClient`'s
    ...
    def get(self, *, authkey: str, auth_appid: str, lang: str, **kwargs: Any) -> _models3.ApiResponseUgcTokenInfo:
        """get.
        ...
        authkey_ver: Literal["1"] = kwargs.pop("authkey_ver", _params.pop("authkey_ver", "1"))
        sign_type: Literal["2"] = kwargs.pop("sign_type", _params.pop("sign_type", "2"))
        cls: ClsType[_models3.ApiResponseUgcTokenInfo] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models3.ApiResponseUgcTokenInfo, response.json())
