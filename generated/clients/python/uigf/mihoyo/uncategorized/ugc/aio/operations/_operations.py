...
class TokenApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.mihoyo.passport.aio.UGCClient`'s
    ...
    async def get(self, *, authkey: str, auth_appid: str, lang: str, **kwargs: Any) -> _models4.ApiResponseUgcTokenInfo:
        """get.
        ...
        :paramtype lang: str
        :return: ApiResponseUgcTokenInfo. The ApiResponseUgcTokenInfo is compatible with MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponseUgcTokenInfo
        ...
        cls: ClsType[_models4.ApiResponseUgcTokenInfo] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models4.ApiResponseUgcTokenInfo, response.json())
