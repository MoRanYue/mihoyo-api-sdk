...
class CreateOrderRequest(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    ...
    :ivar order: Required.
    :vartype order: ~uigf.mihoyo.models.JsonObject
    :ivar sign: Required.
    :vartype sign: str
    """
...
class CurrencyAndCountry(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    """CurrencyAndCountry.
    ...
    :ivar price_tier_version:
    :vartype price_tier_version: str
    """
    ...
    price_tier_version: Optional[str] = rest_field(visibility=["read", "create", "update", "delete", "query"])
    ...
    def __init__(
        ...
        *,
        ...
        price_tier_version: Optional[str] = None,
    ) -> None: ...
...
class ShopGood(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    ...
    :vartype tier_id: str
    :ivar bonus_desc:
    :vartype bonus_desc: ~uigf.mihoyo.commerce.models.BonusDescription
    :ivar once_bonus_desc:
    :vartype once_bonus_desc: ~uigf.mihoyo.commerce.models.BonusDescription
    :ivar available:
...
class ShopGoods(_Model):  # pylint: disable=docstring-keyword-should-match-keyword-only
    ...
    :vartype goods_list: list[~uigf.mihoyo.commerce.models.ShopGood]
    """
