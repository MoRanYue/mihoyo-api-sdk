...
class ShopApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.mihoyo.passport.aio.CommerceClient`'s
    ...
    async def fetch_goods(
        ...
        **kwargs: Any
        ...
        :type game_biz: str
        :param body: Required.
        :type body: ~uigf.mihoyo.commerce.models.ShopGoodsRequest
        ...
        :rtype: ~uigf.mihoyo.models.ApiResponseShopGoods
    ...
    async def fetch_goods(
        ...
        **kwargs: Any
        ...
        :type game_biz: str
        :param body: Required.
        :type body: ~uigf.mihoyo.commerce.types.ShopGoodsRequest
        :keyword cookie: Default value is None.
        :paramtype cookie: str
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
    ...
    async def fetch_goods(
        ...
        **kwargs: Any
        ...
        :type body: ~uigf.mihoyo.commerce.models.ShopGoodsRequest or
         ~uigf.mihoyo.commerce.types.ShopGoodsRequest or IO[bytes]
        :keyword cookie: Default value is None.
        :paramtype cookie: str
        :return: ApiResponseShopGoods. The ApiResponseShopGoods is compatible with MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponseShopGoods
    ...
    async def get_currency_and_country_by_ip(
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models4.ApiResponseCurrencyAndCountry:
        """Returns the storefront currency and country.

        :param game_biz: Required.
        :type game_biz: str
        :param body: Default value is None.
        :type body: ~uigf.mihoyo.models.JsonObject
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ApiResponseCurrencyAndCountry. The ApiResponseCurrencyAndCountry is compatible with
         MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponseCurrencyAndCountry
        :raises ~corehttp.exceptions.HttpResponseError:
        """
    ...
    async def get_currency_and_country_by_ip(
        ...
        **kwargs: Any
        ...
        :type game_biz: str
        :param body: Default value is None.
        :type body: ~uigf.mihoyo.types.JsonObject
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ApiResponseCurrencyAndCountry. The ApiResponseCurrencyAndCountry is compatible with
    ...
    async def get_currency_and_country_by_ip(
        ...
        **kwargs: Any
        ...
        :type body: ~uigf.mihoyo.models.JsonObject or ~uigf.mihoyo.types.JsonObject or IO[bytes]
        :return: ApiResponseCurrencyAndCountry. The ApiResponseCurrencyAndCountry is compatible with
         MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponseCurrencyAndCountry
        :raises ~corehttp.exceptions.HttpResponseError:
        ...
        cls: ClsType[_models4.ApiResponseCurrencyAndCountry] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models4.ApiResponseCurrencyAndCountry, response.json())
    ...
    async def create_order(
        ...
        **kwargs: Any
        ...
        :type game_biz: str
        :param body: Required.
        :type body: ~uigf.mihoyo.commerce.models.CreateOrderRequest
    ...
    async def create_order(
        ...
        **kwargs: Any
        ...
        :type game_biz: str
        :param body: Required.
        :type body: ~uigf.mihoyo.commerce.types.CreateOrderRequest
        :keyword cookie: Required.
        :paramtype cookie: str
        :keyword device_id: Required.
        :paramtype device_id: str
    ...
    async def create_order(
        ...
        **kwargs: Any
        ...
        :type body: ~uigf.mihoyo.commerce.models.CreateOrderRequest or
         ~uigf.mihoyo.commerce.types.CreateOrderRequest or IO[bytes]
        :keyword cookie: Required.
        :paramtype cookie: str
        :keyword device_id: Required.
        :paramtype device_id: str
    ...
    async def check_order(
        ...
        **kwargs: Any
        ...
        :rtype: ~uigf.mihoyo.models.ApiResponseOrderStatus
        :raises ~corehttp.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
