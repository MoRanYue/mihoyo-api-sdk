...
class ShopApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.mihoyo.passport.CommerceClient`'s
    ...
    def get_currency_and_country_by_ip(
        ...
        *,
        content_type: str = "application/json",
        **kwargs: Any
    ) -> _models3.ApiResponseCurrencyAndCountry:
    ...
    def get_currency_and_country_by_ip(
        ...
        **kwargs: Any
        ...
        cls: ClsType[_models3.ApiResponseCurrencyAndCountry] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models3.ApiResponseCurrencyAndCountry, response.json())
