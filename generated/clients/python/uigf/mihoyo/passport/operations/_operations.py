...
def build_web_session_api_verify_cookie_token_request(  # pylint: disable=name-too-long
    *, cookie: str, **kwargs: Any
    ...
    # Construct URL
    _url = "/account/ma-cn-session/web/verifyCookieToken"
...
class AuthTicketApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.mihoyo.passport.PassportClient`'s
    ...
    def create_by_game_biz(
        ...
        :param body: Required.
        :type body: ~uigf.mihoyo.passport.types.AuthTicketRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ApiResponseTokenInfo. The ApiResponseTokenInfo is compatible with MutableMapping
    ...
    def create_by_game_biz(
        ...
        :type body: ~uigf.mihoyo.passport.models.AuthTicketRequest or
         ~uigf.mihoyo.passport.types.AuthTicketRequest or IO[bytes]
        :return: ApiResponseTokenInfo. The ApiResponseTokenInfo is compatible with MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponseTokenInfo
        :raises ~corehttp.exceptions.HttpResponseError:
        """
...
class CaptchaApiOperations:  # pylint: disable=docstring-missing-param
    ...
    ) -> _models2.ApiResponseLoginCaptchaData:
        """Starts the vendor login-captcha challenge. Solve it through the official flow.

        :param body: Required.
        :type body: ~uigf.mihoyo.passport.models.LoginCaptchaRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ApiResponseLoginCaptchaData. The ApiResponseLoginCaptchaData is compatible with
         MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponseLoginCaptchaData
        :raises ~corehttp.exceptions.HttpResponseError:
        """
    ...
    def create(
        ...
        :param body: Required.
        :type body: ~uigf.mihoyo.passport.types.LoginCaptchaRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ApiResponseLoginCaptchaData. The ApiResponseLoginCaptchaData is compatible with
    ...
    def create(
        ...
        :type body: ~uigf.mihoyo.passport.models.LoginCaptchaRequest or
         ~uigf.mihoyo.passport.types.LoginCaptchaRequest or IO[bytes]
        :return: ApiResponseLoginCaptchaData. The ApiResponseLoginCaptchaData is compatible with
         MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponseLoginCaptchaData
        :raises ~corehttp.exceptions.HttpResponseError:
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models2.ApiResponseLoginCaptchaData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models2.ApiResponseLoginCaptchaData, response.json())
...
class QrLoginApiOperations:  # pylint: disable=docstring-missing-param
    ...
    def create(
        ...
        :param body: Required.
        :type body: ~uigf.mihoyo.passport.models.QrLoginCreateRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ApiResponseQrLoginTicket. The ApiResponseQrLoginTicket is compatible with
         MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponseQrLoginTicket
        :raises ~corehttp.exceptions.HttpResponseError:
        """
    ...
    def create(
        ...
        :param body: Required.
        :type body: ~uigf.mihoyo.passport.types.QrLoginCreateRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ApiResponseQrLoginTicket. The ApiResponseQrLoginTicket is compatible with
    ...
    def create(
        ...
        :type body: ~uigf.mihoyo.passport.models.QrLoginCreateRequest or
         ~uigf.mihoyo.passport.types.QrLoginCreateRequest or IO[bytes]
        :return: ApiResponseQrLoginTicket. The ApiResponseQrLoginTicket is compatible with
         MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponseQrLoginTicket
        :raises ~corehttp.exceptions.HttpResponseError:
    ...
    def get_status(
        ...
        :param body: Required.
        :type body: ~uigf.mihoyo.passport.models.QrLoginStatusRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ApiResponseQrLoginStatus. The ApiResponseQrLoginStatus is compatible with
         MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponseQrLoginStatus
        :raises ~corehttp.exceptions.HttpResponseError:
        """
    ...
    def get_status(
        ...
        :param body: Required.
        :type body: ~uigf.mihoyo.passport.types.QrLoginStatusRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ApiResponseQrLoginStatus. The ApiResponseQrLoginStatus is compatible with
    ...
    def get_status(
        ...
        :type body: ~uigf.mihoyo.passport.models.QrLoginStatusRequest or
         ~uigf.mihoyo.passport.types.QrLoginStatusRequest or IO[bytes]
        :return: ApiResponseQrLoginStatus. The ApiResponseQrLoginStatus is compatible with
         MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponseQrLoginStatus
        :raises ~corehttp.exceptions.HttpResponseError:
    ...
    def login_by_mobile_captcha(
        ...
        :param body: Required.
        :type body: ~uigf.mihoyo.passport.models.MobileCaptchaLoginRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ApiResponseTokenInfo. The ApiResponseTokenInfo is compatible with MutableMapping
    ...
    def login_by_mobile_captcha(
        ...
        :param body: Required.
        :type body: ~uigf.mihoyo.passport.types.MobileCaptchaLoginRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ApiResponseTokenInfo. The ApiResponseTokenInfo is compatible with MutableMapping
    ...
    def login_by_mobile_captcha(
        ...
        **kwargs: Any
        ...
        :type body: ~uigf.mihoyo.passport.models.MobileCaptchaLoginRequest or
         ~uigf.mihoyo.passport.types.MobileCaptchaLoginRequest or IO[bytes]
        :return: ApiResponseTokenInfo. The ApiResponseTokenInfo is compatible with MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponseTokenInfo
        :raises ~corehttp.exceptions.HttpResponseError:
        """
    ...
    ) -> _models2.ApiResponseAuthTicketLoginData:
        """Exchanges an official auth ticket for the associated login-session payload.

        :param body: Required.
        :type body: ~uigf.mihoyo.passport.models.AuthTicketLoginRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ApiResponseAuthTicketLoginData. The ApiResponseAuthTicketLoginData is compatible with
         MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponseAuthTicketLoginData
        :raises ~corehttp.exceptions.HttpResponseError:
        """
    ...
    def login_by_auth_ticket(
        ...
        :param body: Required.
        :type body: ~uigf.mihoyo.passport.types.AuthTicketLoginRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ApiResponseAuthTicketLoginData. The ApiResponseAuthTicketLoginData is compatible with
    ...
    def login_by_auth_ticket(
        ...
        **kwargs: Any
        ...
        :type body: ~uigf.mihoyo.passport.models.AuthTicketLoginRequest or
         ~uigf.mihoyo.passport.types.AuthTicketLoginRequest or IO[bytes]
        :return: ApiResponseAuthTicketLoginData. The ApiResponseAuthTicketLoginData is compatible with
         MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponseAuthTicketLoginData
        :raises ~corehttp.exceptions.HttpResponseError:
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models2.ApiResponseAuthTicketLoginData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models2.ApiResponseAuthTicketLoginData, response.json())
...
class SessionApiOperations:  # pylint: disable=docstring-missing-param
    ...
    def get_token_by_game_token(
        ...
        :param body: Required.
        :type body: ~uigf.mihoyo.passport.models.GameTokenRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ApiResponseTokenInfo. The ApiResponseTokenInfo is compatible with MutableMapping
    ...
    def get_token_by_game_token(
        ...
        :param body: Required.
        :type body: ~uigf.mihoyo.passport.types.GameTokenRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ApiResponseTokenInfo. The ApiResponseTokenInfo is compatible with MutableMapping
    ...
    def get_token_by_game_token(
        ...
        :type body: ~uigf.mihoyo.passport.models.GameTokenRequest or
         ~uigf.mihoyo.passport.types.GameTokenRequest or IO[bytes]
        :return: ApiResponseTokenInfo. The ApiResponseTokenInfo is compatible with MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponseTokenInfo
        :raises ~corehttp.exceptions.HttpResponseError:
        """
    ...
    def exchange(
        ...
        :param body: Required.
        :type body: ~uigf.mihoyo.passport.models.TokenExchangeRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ApiResponseTokenInfo. The ApiResponseTokenInfo is compatible with MutableMapping
    ...
    def exchange(
        ...
        :param body: Required.
        :type body: ~uigf.mihoyo.passport.types.TokenExchangeRequest
        :keyword content_type: Body Parameter content-type. Content type parameter for JSON body.
         Default value is "application/json".
        :paramtype content_type: str
        :return: ApiResponseTokenInfo. The ApiResponseTokenInfo is compatible with MutableMapping
    ...
    def exchange(
        ...
        :type body: ~uigf.mihoyo.passport.models.TokenExchangeRequest or
         ~uigf.mihoyo.passport.types.TokenExchangeRequest or IO[bytes]
        :return: ApiResponseTokenInfo. The ApiResponseTokenInfo is compatible with MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponseTokenInfo
        :raises ~corehttp.exceptions.HttpResponseError:
        """
...
class WebSessionApiOperations:  # pylint: disable=docstring-missing-param
    """
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        Instead, you should access the following operations through
        :class:`~uigf.mihoyo.passport.PassportClient`'s
        :attr:`web_session_api` attribute.
    """
    ...
    def verify_cookie_token(self, *, cookie: str, **kwargs: Any) -> _models2.ApiResponse:
        """Verifies a caller-provided browser session cookie.

        :keyword cookie: Required.
        :paramtype cookie: str
        :return: ApiResponse. The ApiResponse is compatible with MutableMapping
        :rtype: ~uigf.mihoyo.models.ApiResponse
        :raises ~corehttp.exceptions.HttpResponseError:
        """
        error_map: MutableMapping = {
            401: ClientAuthenticationError,
        ...
        cls: ClsType[_models2.ApiResponse] = kwargs.pop("cls", None)

        _request = build_web_session_api_verify_cookie_token_request(
            cookie=cookie,
            headers=_headers,
            params=_params,
        )
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models2.ApiResponse, response.json())
