...
from ...operations._operations import (
    ...
    build_web_session_api_verify_cookie_token_request,
)
...
class AuthTicketApiOperations:  # pylint: disable=docstring-missing-param
    ...
    .. warning::
        **DO NOT** instantiate this class directly.
        ...
        :class:`~uigf.mihoyo.passport.aio.PassportClient`'s
...
class CaptchaApiOperations:  # pylint: disable=docstring-missing-param
    ...
    ) -> _models3.ApiResponseLoginCaptchaData:
    ...
    async def create(
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models3.ApiResponseLoginCaptchaData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models3.ApiResponseLoginCaptchaData, response.json())
...
class QrLoginApiOperations:  # pylint: disable=docstring-missing-param
    ...
    ) -> _models3.ApiResponseAuthTicketLoginData:
    ...
    async def login_by_auth_ticket(
        ...
        **kwargs: Any
        ...
        content_type: Optional[str] = kwargs.pop("content_type", _headers.pop("Content-Type", None))
        cls: ClsType[_models3.ApiResponseAuthTicketLoginData] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models3.ApiResponseAuthTicketLoginData, response.json())
...
class WebSessionApiOperations:  # pylint: disable=docstring-missing-param
    ...
    async def verify_cookie_token(self, *, cookie: str, **kwargs: Any) -> _models3.ApiResponse:
        ...
        cls: ClsType[_models3.ApiResponse] = kwargs.pop("cls", None)
        ...
        if _stream:
            ...
            deserialized = _deserialize(_models3.ApiResponse, response.json())
