...
class PassportClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype auth_ticket_api: uigf.mihoyo.passport.aio.operations.AuthTicketApiOperations
    :ivar captcha_api: CaptchaApiOperations operations
    :vartype captcha_api: uigf.mihoyo.passport.aio.operations.CaptchaApiOperations
    :ivar qr_login_api: QrLoginApiOperations operations
    :vartype qr_login_api: uigf.mihoyo.passport.aio.operations.QrLoginApiOperations
    :ivar session_api: SessionApiOperations operations
    :vartype session_api: uigf.mihoyo.passport.aio.operations.SessionApiOperations
    :ivar web_session_api: WebSessionApiOperations operations
    :vartype web_session_api: uigf.mihoyo.passport.aio.operations.WebSessionApiOperations
    :ivar account_token_api: AccountTokenApiOperations operations
    :vartype account_token_api: uigf.mihoyo.passport.aio.operations.AccountTokenApiOperations
    ...
    def __init__(  # pylint: disable=missing-client-constructor-parameter-credential
        ...
        self.web_session_api = WebSessionApiOperations(self._client, self._config, self._serialize, self._deserialize)
