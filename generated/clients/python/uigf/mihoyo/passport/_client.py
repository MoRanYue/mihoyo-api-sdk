...
class PassportClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype auth_ticket_api: uigf.mihoyo.passport.operations.AuthTicketApiOperations
    :ivar captcha_api: CaptchaApiOperations operations
    :vartype captcha_api: uigf.mihoyo.passport.operations.CaptchaApiOperations
    :ivar qr_login_api: QrLoginApiOperations operations
    :vartype qr_login_api: uigf.mihoyo.passport.operations.QrLoginApiOperations
    :ivar session_api: SessionApiOperations operations
    :vartype session_api: uigf.mihoyo.passport.operations.SessionApiOperations
    :ivar web_session_api: WebSessionApiOperations operations
    :vartype web_session_api: uigf.mihoyo.passport.operations.WebSessionApiOperations
    :ivar account_token_api: AccountTokenApiOperations operations
    :vartype account_token_api: uigf.mihoyo.passport.operations.AccountTokenApiOperations
