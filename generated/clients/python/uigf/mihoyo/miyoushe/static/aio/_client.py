...
class StaticClient:  # pylint: disable=client-accepts-api-version-keyword
    ...
    :vartype static_api_hub: uigf.mihoyo.passport.aio.operations.StaticApiHubOperations
    :ivar static_misc_api: StaticMiscApiOperations operations
    :vartype static_misc_api: uigf.mihoyo.passport.aio.operations.StaticMiscApiOperations
    :ivar static_preload_api: StaticPreloadApiOperations operations
    :vartype static_preload_api: uigf.mihoyo.passport.aio.operations.StaticPreloadApiOperations
    :ivar static_search_api: StaticSearchApiOperations operations
    :vartype static_search_api: uigf.mihoyo.passport.aio.operations.StaticSearchApiOperations
