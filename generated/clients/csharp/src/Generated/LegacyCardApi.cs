...
{
    /// <summary> The LegacyCardApi sub-client. </summary>
    public partial class LegacyCardApi
    {
        private readonly Uri _endpoint;

        /// <summary> Initializes a new instance of LegacyCardApi for mocking. </summary>
        protected LegacyCardApi()
        {
        }
        ...
        internal LegacyCardApi(ClientPipeline pipeline, Uri endpoint)
        {
            _endpoint = endpoint;
            Pipeline = pipeline;
        }
