...
namespace UIGF.Mihoyo.Api.Response
{
    ...
    public partial class MobilePreloadConfigData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="MobilePreloadConfigData"/>. </summary>
        internal MobilePreloadConfigData()
        {
        ...
        internal MobilePreloadConfigData(bool? needPreload, bool? needUpdate, IList<IDictionary<string, BinaryData>> rnPreload, IList<BinaryData> rnUpdateInfos, IReadOnlyDictionary<string, BinaryData> additionalProperties)
        {
            NeedPreload = needPreload;
            NeedUpdate = needUpdate;
            RnPreload = rnPreload;
            RnUpdateInfos = rnUpdateInfos;
            _additionalBinaryDataProperties = new ChangeTrackingDictionary<string, BinaryData>(additionalProperties);
        }

        /// <summary> Gets the NeedPreload. </summary>
        public bool? NeedPreload { get; }

        /// <summary> Gets the NeedUpdate. </summary>
        ...
        /// </para>
        /// </summary>
        public IList<IDictionary<string, BinaryData>> RnPreload { get; }

        /// <summary>
        /// Gets the RnUpdateInfos.
        /// <para> To assign an object to the element of this property use <see cref="BinaryData.FromObjectAsJson{T}(T, JsonSerializerOptions?)"/>. </para>
        /// <para> To assign an already formatted json string to this property use <see cref="BinaryData.FromString(string)"/>. </para>
        /// <para>
        /// Examples:
        ...
        /// </para>
        /// </summary>
        public IList<BinaryData> RnUpdateInfos { get; }
