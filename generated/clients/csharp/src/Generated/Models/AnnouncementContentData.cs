...
namespace UIGF.Mihoyo.Game.Response
{
    ...
    public partial class AnnouncementContentData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="AnnouncementContentData"/>. </summary>
        internal AnnouncementContentData()
        {
        ...
        internal AnnouncementContentData(IList<AnnouncementContentItem> list, IList<BinaryData> picList, int? picTotal, int? total, IReadOnlyDictionary<string, BinaryData> additionalProperties)
        {
            List = list;
            PicList = picList;
            PicTotal = picTotal;
        ...
        public IList<AnnouncementContentItem> List { get; }
