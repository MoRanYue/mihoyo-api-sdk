...
namespace UIGF.Mihoyo.Game.Response
{
    ...
    public partial class GcgDeckListData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="GcgDeckListData"/>. </summary>
        internal GcgDeckListData()
        {
        ...
        internal GcgDeckListData(IList<IDictionary<string, BinaryData>> deckList, int? level, string nickname, string roleId, IReadOnlyDictionary<string, BinaryData> additionalProperties)
        {
            DeckList = deckList;
            Level = level;
            Nickname = nickname;
        ...
        /// </para>
        /// </summary>
        public IList<IDictionary<string, BinaryData>> DeckList { get; }
