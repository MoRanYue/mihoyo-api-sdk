...
namespace UIGF.Mihoyo.Game.Response
{
    ...
    public partial class AnnouncementPictureData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="AnnouncementPictureData"/>. </summary>
        internal AnnouncementPictureData()
        {
        ...
        internal AnnouncementPictureData(IList<BinaryData> list, int? total, IReadOnlyDictionary<string, BinaryData> additionalProperties)
        {
            List = list;
            Total = total;
