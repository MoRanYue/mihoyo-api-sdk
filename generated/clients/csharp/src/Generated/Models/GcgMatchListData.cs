...
namespace UIGF.Mihoyo.Game.Response
{
    ...
    public partial class GcgMatchListData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="GcgMatchListData"/>. </summary>
        internal GcgMatchListData()
        {
        ...
        internal GcgMatchListData(IList<BinaryData> favouriteMatches, IList<IDictionary<string, BinaryData>> recentMatches, IReadOnlyDictionary<string, BinaryData> additionalProperties)
        {
        ...
        /// </para>
        /// </summary>
        public IList<BinaryData> FavouriteMatches { get; }

        /// <summary>
        /// Gets the RecentMatches.
        /// <para> To assign an object to the element of this property use <see cref="BinaryData.FromObjectAsJson{T}(T, JsonSerializerOptions?)"/>. </para>
        /// <para> To assign an already formatted json string to this property use <see cref="BinaryData.FromString(string)"/>. </para>
        /// <para>
        /// Examples:
        ...
        /// </para>
        /// </summary>
        public IList<IDictionary<string, BinaryData>> RecentMatches { get; }
