...
namespace UIGF.Mihoyo.Game.Response
{
    ...
    public partial class GenshinStygianData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="GenshinStygianData"/>. </summary>
        internal GenshinStygianData()
        {
        ...
        internal GenshinStygianData(IList<IDictionary<string, BinaryData>> data, bool? isUnlock, IDictionary<string, BinaryData> links, IReadOnlyDictionary<string, BinaryData> additionalProperties)
        {
            Data = data;
            IsUnlock = isUnlock;
            Links = links;
