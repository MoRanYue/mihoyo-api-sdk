...
namespace UIGF.Mihoyo.Game.Response
{
    ...
    public partial class GcgCoversData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="GcgCoversData"/>. </summary>
        internal GcgCoversData()
        {
        ...
        internal GcgCoversData(IList<IDictionary<string, BinaryData>> covers, IReadOnlyDictionary<string, BinaryData> additionalProperties)
        {
            Covers = covers;
