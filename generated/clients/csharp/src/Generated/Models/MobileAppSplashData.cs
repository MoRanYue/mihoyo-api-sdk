...
namespace UIGF.Mihoyo.Api.Response
{
    ...
    public partial class MobileAppSplashData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="MobileAppSplashData"/>. </summary>
        internal MobileAppSplashData()
        {
        ...
        internal MobileAppSplashData(bool? hasSplash, IList<BinaryData> splashes, IReadOnlyDictionary<string, BinaryData> additionalProperties)
        {
            HasSplash = hasSplash;
            Splashes = splashes;
        ...
        /// <summary> Gets the HasSplash. </summary>
        ...
        /// </para>
        /// </summary>
        public IList<BinaryData> Splashes { get; }
