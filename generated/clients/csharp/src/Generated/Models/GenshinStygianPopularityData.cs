...
namespace UIGF.Mihoyo.Game.Response
{
    ...
    public partial class GenshinStygianPopularityData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="GenshinStygianPopularityData"/>. </summary>
        internal GenshinStygianPopularityData()
        {
        ...
        internal GenshinStygianPopularityData(IList<IDictionary<string, BinaryData>> avatarList, IReadOnlyDictionary<string, BinaryData> additionalProperties)
        {
