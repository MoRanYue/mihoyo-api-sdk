...
namespace UIGF.Mihoyo.Game.Response
{
    ...
    public partial class GenshinGameRecordCardData
    {
        /// <summary> Keeps track of any properties unknown to the library. </summary>
        private protected readonly IDictionary<string, BinaryData> _additionalBinaryDataProperties;

        /// <summary> Initializes a new instance of <see cref="GenshinGameRecordCardData"/>. </summary>
        internal GenshinGameRecordCardData()
        {
        ...
        internal GenshinGameRecordCardData(IList<IDictionary<string, BinaryData>> list, IReadOnlyDictionary<string, BinaryData> additionalProperties)
        {
            List = list;
