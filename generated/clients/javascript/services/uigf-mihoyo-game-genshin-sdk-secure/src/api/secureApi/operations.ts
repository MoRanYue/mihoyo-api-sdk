...
import { MihoyoGameGenshinSDKSecureContext as Client } from "../index.js";
import {
...
import {
  ...
  apiResponseSdkProtocolVersionComparisonDataDeserializer,
  ApiResponseSdkRedDotData,
  apiResponseSdkRedDotDataDeserializer,
...
export async function _getRedDotsDeserialize(
  ...
  return apiResponseSdkRedDotDataDeserializer(result.body);
}
...
export async function _compareProtocolVersionDeserialize(
  ...
  return apiResponseSdkProtocolVersionComparisonDataDeserializer(result.body);
}
