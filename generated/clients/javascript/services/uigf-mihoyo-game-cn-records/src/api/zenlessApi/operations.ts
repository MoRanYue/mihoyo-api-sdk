...
import {
  ...
  apiResponseZenlessIndexDataDeserializer,
  ApiResponseZenlessDailyNoteData,
  apiResponseZenlessDailyNoteDataDeserializer,
  ApiResponseGachaLogPage,
  apiResponseGachaLogPageDeserializer,
  ApiResponseZenlessShiyuDefenseData,
  apiResponseZenlessShiyuDefenseDataDeserializer,
...
export function _getShiyuDefenseSend(
  ...
  const path = expandUrlTemplate(
    "/event/game_record_zzz/api/zzz/hadal_info_v2{?without_v2_detail,schedule_type,need_detail,need_all,server,role_id}",
    {
      without_v2_detail: options?.withoutV2Detail,
...
export async function _getShiyuDefenseDeserialize(
  ...
  return apiResponseZenlessShiyuDefenseDataDeserializer(result.body);
}
...
export async function _getDailyNoteDeserialize(
  ...
  return apiResponseZenlessDailyNoteDataDeserializer(result.body);
}
...
export async function _getIndexDeserialize(
  ...
  return apiResponseZenlessIndexDataDeserializer(result.body);
}
