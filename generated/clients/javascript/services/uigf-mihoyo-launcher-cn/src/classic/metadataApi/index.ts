...
import { MihoyoLauncherCNContext } from "../../api/mihoyoLauncherCNContext.js";
import {
  getDxConfigs,
  getWpfPackages,
  getGameBranches,
...
import { DxConfigRequest } from "../../models/uigf/mihoyo/launcher/models.js";
import {
...
function _getMetadataApi(context: MihoyoLauncherCNContext) {
  return {
    getDxConfigs: (
      launcherId: string,
      language: string,
...
export function _getMetadataApiOperations(context: MihoyoLauncherCNContext): MetadataApiOperations {
  return {
