...
import {
  MihoyoGameAccountContext,
  MihoyoGameAccountClientOptionalParams,
  createMihoyoGameAccount,
} from "./api/index.js";
import {
...
export type { MihoyoGameAccountClientOptionalParams } from "./api/mihoyoGameAccountContext.js";

export class MihoyoGameAccountClient {
  private _client: MihoyoGameAccountContext;
  /** The pipeline used by this client to make requests */
  public readonly pipeline: Pipeline;

  constructor(options: MihoyoGameAccountClientOptionalParams = {}) {
    this._client = createMihoyoGameAccount(options);
