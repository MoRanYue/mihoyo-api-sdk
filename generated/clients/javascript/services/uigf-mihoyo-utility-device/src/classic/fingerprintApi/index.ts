...
import { MihoyoUtilityDeviceContext } from "../../api/mihoyoUtilityDeviceContext.js";
...
import { DeviceFingerprintRequest } from "../../models/uigf/mihoyo/game/models.js";
import {
...
function _getFingerprintApi(context: MihoyoUtilityDeviceContext) {
  return {
    getFingerprint: (
      appVersion: string,
      clientType: string,
...
export function _getFingerprintApiOperations(
  context: MihoyoUtilityDeviceContext,
