...
import {
  MihoyoGameGlobalRecordsContext,
  MihoyoGameGlobalRecordsClientOptionalParams,
  createMihoyoGameGlobalRecords,
} from "./api/index.js";
import {
...
export type { MihoyoGameGlobalRecordsClientOptionalParams } from "./api/mihoyoGameGlobalRecordsContext.js";

export class MihoyoGameGlobalRecordsClient {
  private _client: MihoyoGameGlobalRecordsContext;
  /** The pipeline used by this client to make requests */
  public readonly pipeline: Pipeline;

  constructor(options: MihoyoGameGlobalRecordsClientOptionalParams = {}) {
    this._client = createMihoyoGameGlobalRecords(options);
