...
import { ApiResponseJsonObject, ApiResponseGachaLogPage } from "../../models/uigf/mihoyo/models.js";
...
function _getZenlessGameRecordApi(context: MihoyoGameGlobalRecordsContext) {
  return {
    getThresholdSimulationDetail: (
      cookie: string,
      region: string,
