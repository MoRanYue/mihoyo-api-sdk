...
import { MihoyoLauncherGlobalContext } from "../../api/mihoyoLauncherGlobalContext.js";
import {
  getDxConfigs,
  getWpfPackages,
  getGameBranches,
...
function _getMetadataApi(context: MihoyoLauncherGlobalContext) {
  return {
    getDxConfigs: (
      launcherId: string,
      language: string,
...
export function _getMetadataApiOperations(
  context: MihoyoLauncherGlobalContext,
