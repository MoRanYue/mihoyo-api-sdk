...
import { MihoyoGameGenshinAnnouncementContentContext as Client } from "../index.js";
import {
  ApiResponseAnnouncementContentData,
  apiResponseAnnouncementContentDataDeserializer,
...
export async function _getDeserialize(
  ...
  return apiResponseAnnouncementContentDataDeserializer(result.body);
}
