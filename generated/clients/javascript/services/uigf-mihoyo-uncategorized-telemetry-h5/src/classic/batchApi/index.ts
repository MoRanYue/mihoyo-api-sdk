...
import { MihoyoUncategorizedTelemetryH5Context } from "../../api/mihoyoUncategorizedTelemetryH5Context.js";
...
function _getBatchApi(context: MihoyoUncategorizedTelemetryH5Context) {
  return {
...
export function _getBatchApiOperations(
  context: MihoyoUncategorizedTelemetryH5Context,
): BatchApiOperations {
  return {
