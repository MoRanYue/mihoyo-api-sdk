...
import { MihoyoLauncherSophonCNContext } from "../../api/mihoyoLauncherSophonCNContext.js";
...
function _getBuildApi(context: MihoyoLauncherSophonCNContext) {
  return {
    getPatchBuild: (
      branch: string,
      packageId: string,
...
export function _getBuildApiOperations(context: MihoyoLauncherSophonCNContext): BuildApiOperations {
  return {
