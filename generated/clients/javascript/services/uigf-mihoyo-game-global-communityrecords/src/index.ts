...
export { MihoyoGameGlobalCommunityRecordsClient } from "./mihoyoGameGlobalCommunityRecordsClient.js";
export type {
...
export type { MihoyoGameGlobalCommunityRecordsClientOptionalParams } from "./api/index.js";
export type {
