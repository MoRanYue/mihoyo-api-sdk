...
import { MihoyoUncategorizedTelemetryCommunityContext as Client } from "../index.js";
import {
  CommunityTelemetryUploadRequest,
  communityTelemetryUploadRequestSerializer,
...
export function _uploadSend(
  ...
  return context
    ...
    .post({
      ...
      body: communityTelemetryUploadRequestSerializer(body),
    });
}
