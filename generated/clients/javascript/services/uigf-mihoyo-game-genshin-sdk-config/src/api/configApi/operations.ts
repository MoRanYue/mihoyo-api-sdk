...
import { MihoyoGameGenshinSDKConfigContext as Client } from "../index.js";
import {
  ApiResponseSdkComboConfigData,
  apiResponseSdkComboConfigDataDeserializer,
  ApiResponseSdkPrecacheConfigData,
  apiResponseSdkPrecacheConfigDataDeserializer,
  ApiResponseSdkGranterConfigData,
  apiResponseSdkGranterConfigDataDeserializer,
  ApiResponseSdkShieldConfigData,
  apiResponseSdkShieldConfigDataDeserializer,
...
export async function _getShieldConfigDeserialize(
  ...
  return apiResponseSdkShieldConfigDataDeserializer(result.body);
}
...
export async function _getGranterConfigDeserialize(
  ...
  return apiResponseSdkGranterConfigDataDeserializer(result.body);
}
...
export async function _getPrecacheDeserialize(
  ...
  return apiResponseSdkPrecacheConfigDataDeserializer(result.body);
}
...
export async function _getComboDeserialize(
  ...
  return apiResponseSdkComboConfigDataDeserializer(result.body);
}
