...
/** model interface CurrencyAndCountry */
export interface CurrencyAndCountry {
  country?: string;
  currency?: string;
  priceTierVersion?: string;
  /** Additional properties */
  additionalProperties?: Record<string, any>;
}

export function currencyAndCountryDeserializer(item: any): CurrencyAndCountry {
  return {
    additionalProperties: serializeRecord(item, ["country", "currency", "price_tier_version"]),
    country: item["country"],
    currency: item["currency"],
    priceTierVersion: item["price_tier_version"],
  };
}
