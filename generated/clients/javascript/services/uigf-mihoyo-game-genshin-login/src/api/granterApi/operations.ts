...
import { MihoyoGameGenshinLoginContext as Client } from "../index.js";
import {
  GranterLoginRequest,
...
import {
  ...
  apiResponseGranterLoginDataDeserializer,
...
export async function _loginDeserialize(
  ...
  return apiResponseGranterLoginDataDeserializer(result.body);
}
