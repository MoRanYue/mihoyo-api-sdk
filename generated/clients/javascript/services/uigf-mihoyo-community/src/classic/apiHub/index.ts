...
import { SignInRequest, LikePostRequest } from "../../models/uigf/mihoyo/community/models.js";
import {
...
export interface ApiHubOperations {
  ...
  getHome: (
    gids: number,
    options?: ApiHubGetHomeOptionalParams,
  ...
  getAppConfig: (
    options?: ApiHubGetAppConfigOptionalParams,
...
function _getApiHub(context: MihoyoCommunityContext) {
  return {
    setPostVote: (
      cookie: string,
      body: LikePostRequest,
...
export function _getApiHubOperations(context: MihoyoCommunityContext): ApiHubOperations {
  return {
    ..._getApiHub(context),
  };
}
