...
import { FavoritePostRequest } from "../../models/uigf/mihoyo/community/models.js";
import {
...
function _getPostApi(context: MihoyoCommunityContext) {
  return {
    setFavorite: (
      cookie: string,
      body: FavoritePostRequest,
...
export function _getPostApiOperations(context: MihoyoCommunityContext): PostApiOperations {
  return {
    ..._getPostApi(context),
  };
}
