...
import { MihoyoGameGlobalGenshinContext } from "../../api/mihoyoGameGlobalGenshinContext.js";
...
import { ApiResponseAnnouncementList } from "../../models/uigf/mihoyo/models.js";
...
function _getAnnouncementApi(context: MihoyoGameGlobalGenshinContext) {
  return {
    getAlert: (
      game: string,
      gameBiz: string,
...
export function _getAnnouncementApiOperations(
  context: MihoyoGameGlobalGenshinContext,
