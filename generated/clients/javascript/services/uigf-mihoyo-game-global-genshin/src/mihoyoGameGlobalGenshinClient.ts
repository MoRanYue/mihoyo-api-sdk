...
import {
  MihoyoGameGlobalGenshinContext,
  MihoyoGameGlobalGenshinClientOptionalParams,
  createMihoyoGameGlobalGenshin,
} from "./api/index.js";
import {
...
export type { MihoyoGameGlobalGenshinClientOptionalParams } from "./api/mihoyoGameGlobalGenshinContext.js";

export class MihoyoGameGlobalGenshinClient {
  private _client: MihoyoGameGlobalGenshinContext;
  /** The pipeline used by this client to make requests */
  public readonly pipeline: Pipeline;

  constructor(options: MihoyoGameGlobalGenshinClientOptionalParams = {}) {
    this._client = createMihoyoGameGlobalGenshin(options);
