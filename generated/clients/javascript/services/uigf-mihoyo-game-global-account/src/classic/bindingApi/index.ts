...
import { MihoyoGameGlobalAccountContext } from "../../api/mihoyoGameGlobalAccountContext.js";
...
function _getBindingApi(context: MihoyoGameGlobalAccountContext) {
  return {
...
export function _getBindingApiOperations(
  context: MihoyoGameGlobalAccountContext,
