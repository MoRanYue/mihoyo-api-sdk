...
import { MihoyoGameGenshinGachaContext } from "../../api/mihoyoGameGenshinGachaContext.js";
...
import { ApiResponseGachaLogPage } from "../../models/uigf/mihoyo/models.js";
...
function _getGachaLogApi(context: MihoyoGameGenshinGachaContext) {
  return {
    getBeyondHistory: (
      gachaType: string,
      authkey: string,
...
export function _getGachaLogApiOperations(
  context: MihoyoGameGenshinGachaContext,
