...
import {
  MihoyoPassportContext,
  MihoyoPassportClientOptionalParams,
  createMihoyoPassport,
} from "./api/index.js";
import {
...
import {
  ...
  _getWebSessionApiOperations,
} from "./classic/webSessionApi/index.js";
import { Pipeline } from "@azure/core-rest-pipeline";

export type { MihoyoPassportClientOptionalParams } from "./api/mihoyoPassportContext.js";

export class MihoyoPassportClient {
  private _client: MihoyoPassportContext;
  /** The pipeline used by this client to make requests */
  public readonly pipeline: Pipeline;

  constructor(options: MihoyoPassportClientOptionalParams = {}) {
    this._client = createMihoyoPassport(options);
    this.pipeline = this._client.pipeline;
    this.accountTokenApi = _getAccountTokenApiOperations(this._client);
    this.webSessionApi = _getWebSessionApiOperations(this._client);
  ...
  /** The operation groups for webSessionApi */
  public readonly webSessionApi: WebSessionApiOperations;
