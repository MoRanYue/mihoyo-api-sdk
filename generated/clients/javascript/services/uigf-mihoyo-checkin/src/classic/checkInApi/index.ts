...
import { MihoyoCheckInContext } from "../../api/mihoyoCheckInContext.js";
...
import { LunaCheckInRequest } from "../../models/uigf/mihoyo/community/models.js";
...
function _getCheckInApi(context: MihoyoCheckInContext) {
  return {
    resign: (
      game: string,
      cookie: string,
...
export function _getCheckInApiOperations(context: MihoyoCheckInContext): CheckInApiOperations {
  return {
