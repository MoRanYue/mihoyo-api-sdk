...
import {
  MihoyoGameCNEventsContext,
  MihoyoGameCNEventsClientOptionalParams,
  createMihoyoGameCNEvents,
} from "./api/index.js";
import {
...
export type { MihoyoGameCNEventsClientOptionalParams } from "./api/mihoyoGameCNEventsContext.js";

export class MihoyoGameCNEventsClient {
  private _client: MihoyoGameCNEventsContext;
  /** The pipeline used by this client to make requests */
  public readonly pipeline: Pipeline;

  constructor(options: MihoyoGameCNEventsClientOptionalParams = {}) {
    this._client = createMihoyoGameCNEvents(options);
