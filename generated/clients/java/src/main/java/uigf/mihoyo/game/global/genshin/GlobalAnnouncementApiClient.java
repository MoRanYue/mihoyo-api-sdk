package uigf.mihoyo.game.global.genshin;
...
import uigf.mihoyo.ApiResponseAnnouncementList;
import uigf.mihoyo.ListRequestPlatform;
import uigf.mihoyo.checkin.implementation.GlobalAnnouncementApisImpl;
...
public final class GlobalAnnouncementApiClient {
    ...
    public Response<ApiResponseAnnouncementList> listWithResponse(String game, String gameBiz, String lang,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Game.Global.Genshin.AnnouncementApi.list",
    ...
    public Response<ApiResponseAnnouncementList> getContentWithResponse(String game, String gameBiz, String lang,
        String bundleId, ListRequestPlatform platform, String region, Integer level, String uid, Integer channelId,
        RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Game.Global.Genshin.AnnouncementApi.getContent",
    ...
    public Response<ApiResponseAnnouncementList> getAlertWithResponse(String game, String gameBiz, String lang,
        String bundleId, ListRequestPlatform platform, String region, Integer level, String uid, Integer channelId,
        RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Game.Global.Genshin.AnnouncementApi.getAlert",
