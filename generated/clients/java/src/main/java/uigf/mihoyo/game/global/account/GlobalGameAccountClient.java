package uigf.mihoyo.game.global.account;
...
import uigf.mihoyo.checkin.implementation.GlobalBindingApisImpl;
...
public final class GlobalGameAccountClient {
    ...
    public Response<ApiResponseGameRoleList> getRolesWithResponse(String cookie, String gameBiz,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Game.Global.Account.BindingApi.getRoles",
