...
import uigf.mihoyo.checkin.implementation.GlobalStarRailLedgerApisImpl;
...
public final class GlobalStarRailLedgerApiClient {
    ...
    public Response<ApiResponseJsonObject> getMonthInfoWithResponse(String cookie, String roleId, String server,
        ...
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Game.Global.Records.StarRailLedgerApi.getMonthInfo", requestContext,
            updatedContext -> this.serviceClient.getMonthInfoWithResponse(cookie, roleId, server, month, lang,
                updatedContext));
    }
    ...
    public Response<ApiResponseJsonObject> getMonthDetailWithResponse(String cookie, int type, int currentPage,
        ...
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Game.Global.Records.StarRailLedgerApi.getMonthDetail", requestContext,
            updatedContext -> this.serviceClient.getMonthDetailWithResponse(cookie, type, currentPage, roleId, server,
                pageSize, month, lang, updatedContext));
    }
