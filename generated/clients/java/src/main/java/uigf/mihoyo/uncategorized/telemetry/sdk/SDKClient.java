package uigf.mihoyo.uncategorized.telemetry.sdk;
...
import uigf.mihoyo.api.request.SdkTelemetryUploadEvent;
import uigf.mihoyo.checkin.implementation.SdkTelemetryUploadApisImpl;
...
public final class SDKClient {
    ...
    public Response<UploadResponse> uploadWithResponse(List<SdkTelemetryUploadEvent> body, String authorization,
        String contentMd5, String date, String cmsSignature, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Uncategorized.Telemetry.SDK.UploadApi.upload",
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @ServiceMethod(returns = ReturnType.SINGLE)
    public UploadResponse upload(List<SdkTelemetryUploadEvent> body, String authorization, String contentMd5,
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @ServiceMethod(returns = ReturnType.SINGLE)
    public UploadResponse upload(List<SdkTelemetryUploadEvent> body) {
