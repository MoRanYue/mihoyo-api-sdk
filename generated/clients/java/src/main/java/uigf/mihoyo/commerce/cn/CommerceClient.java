package uigf.mihoyo.commerce.cn;
...
import uigf.mihoyo.ApiResponseCurrencyAndCountry;
import uigf.mihoyo.ApiResponseJsonObject;
import uigf.mihoyo.ApiResponseOrderStatus;
import uigf.mihoyo.ApiResponseShopGoods;
import uigf.mihoyo.JsonObject;
import uigf.mihoyo.checkin.implementation.ShopApisImpl;
import uigf.mihoyo.commerce.CreateOrderRequest;
import uigf.mihoyo.commerce.ShopGoodsRequest;
...
public final class CommerceClient {
    ...
    public Response<ApiResponseShopGoods> fetchGoodsWithResponse(String gameBiz, ShopGoodsRequest body, String cookie,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Commerce.CN.ShopApi.fetchGoods", requestContext,
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ApiResponseCurrencyAndCountry> getCurrencyAndCountryByIpWithResponse(String gameBiz,
        JsonObject body, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Commerce.CN.ShopApi.getCurrencyAndCountryByIp",
            requestContext,
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ApiResponseCurrencyAndCountry getCurrencyAndCountryByIp(String gameBiz, JsonObject body) {
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ApiResponseCurrencyAndCountry getCurrencyAndCountryByIp(String gameBiz) {
    ...
    public Response<ApiResponseJsonObject> createOrderWithResponse(String gameBiz, String cookie, String deviceId,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Commerce.CN.ShopApi.createOrder",
            requestContext, updatedContext -> this.serviceClient.createOrderWithResponse(gameBiz, cookie, deviceId,
                body, updatedContext));
    }
    ...
    public Response<ApiResponseOrderStatus> checkOrderWithResponse(String gameBiz, String orderNo, String game,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Commerce.CN.ShopApi.checkOrder", requestContext,
