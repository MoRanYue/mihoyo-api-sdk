package uigf.mihoyo.launcher.sophon.global;
...
import uigf.mihoyo.checkin.implementation.GlobalSophonBuildApisImpl;
...
public final class GlobalSophonClient {
    ...
    public Response<ApiResponseJsonObject> getBuildWithResponse(String branch, String packageId, String password,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Launcher.Sophon.Global.BuildApi.getBuild",
    ...
    public Response<ApiResponseJsonObject> getPatchBuildWithResponse(String branch, String packageId, String password,
        String tag, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Launcher.Sophon.Global.BuildApi.getPatchBuild",
