...
import uigf.mihoyo.ApiResponseLoginCaptchaData;
import uigf.mihoyo.passport.LoginCaptchaRequest;
...
public final class CaptchaApisImpl {
    ...
    public interface CaptchaApisService {
        static CaptchaApisService getNewInstance(HttpPipeline pipeline) {
            try {
                Class<?> clazz = Class.forName("uigf.mihoyo.checkin.implementation.CaptchaApisServiceImpl");
        ...
        Response<ApiResponseLoginCaptchaData> create(@HostParam("endpoint") String endpoint,
    ...
    public Response<ApiResponseLoginCaptchaData> createWithResponse(LoginCaptchaRequest body,
        RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Passport.CaptchaApi.create", requestContext,
            updatedContext -> {
