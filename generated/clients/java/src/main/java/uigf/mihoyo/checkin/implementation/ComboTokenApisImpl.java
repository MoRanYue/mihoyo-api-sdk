...
import uigf.mihoyo.ApiResponseComboTokenUploadCredentials;
import uigf.mihoyo.uncategorized.ComboTokenRequest;
...
public final class ComboTokenApisImpl {
    ...
    public interface ComboTokenApisService {
        static ComboTokenApisService getNewInstance(HttpPipeline pipeline) {
            try {
                Class<?> clazz = Class.forName("uigf.mihoyo.checkin.implementation.ComboTokenApisServiceImpl");
        ...
        Response<ApiResponseComboTokenUploadCredentials> exchange(@HostParam("endpoint") String endpoint,
    ...
    public Response<ApiResponseComboTokenUploadCredentials> exchangeWithResponse(ComboTokenRequest body,
        RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Uncategorized.ComboToken.ComboTokenApi.exchange", requestContext, updatedContext -> {
