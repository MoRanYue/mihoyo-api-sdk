package uigf.mihoyo.game.genshin.announcementcontent;
...
import uigf.mihoyo.checkin.implementation.ContentApisImpl;
...
public final class AnnouncementContentClient {
    ...
    public Response<ApiResponseAnnouncementContentData> getWithResponse(String game, String gameBiz, String lang,
        ...
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Game.Genshin.AnnouncementContent.ContentApi.get", requestContext,
            updatedContext -> this.serviceClient.getWithResponse(game, gameBiz, lang, bundleId, platform, region, t,
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ApiResponseAnnouncementContentData get(String game, String gameBiz, String lang, String bundleId,
