...
import uigf.mihoyo.checkin.implementation.CnStarRailLedgerApisImpl;
...
public final class CnStarRailLedgerApiClient {
    ...
    public Response<ApiResponseJsonObject> getMonthInfoWithResponse(String cookie, String roleId, String server,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Game.CN.Events.StarRailLedgerApi.getMonthInfo",
    ...
    public Response<ApiResponseJsonObject> getMonthDetailWithResponse(String cookie, int type, int currentPage,
        ...
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Game.CN.Events.StarRailLedgerApi.getMonthDetail", requestContext,
