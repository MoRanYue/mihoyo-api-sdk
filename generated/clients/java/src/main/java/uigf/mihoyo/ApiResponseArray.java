...
import uigf.mihoyo.uncategorized.ExperimentAssignment;
...
public class ApiResponseArray implements JsonSerializable<ApiResponseArray> {
     ...
     */
    @Metadata(properties = { MetadataProperties.GENERATED })
    private final List<ExperimentAssignment> data;
     ...
     */
    @Metadata(properties = { MetadataProperties.GENERATED })
    protected ApiResponseArray(int retcode, String message, List<ExperimentAssignment> data) {
     ...
     */
    @Metadata(properties = { MetadataProperties.GENERATED })
    public List<ExperimentAssignment> getData() {
        return this.data;
    }
    ...
    public static ApiResponseArray fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            int retcode = 0;
            String message = null;
            List<ExperimentAssignment> data = null;
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                if ("retcode".equals(fieldName)) {
                    ...
                    data = reader.readArray(reader1 -> ExperimentAssignment.fromJson(reader1));
                } else {
                    reader.skipChildren();
                }
            }
