package uigf.mihoyo.game.genshin.dispatch.gate;
...
import uigf.mihoyo.ApiResponseGateAddressData;
import uigf.mihoyo.checkin.implementation.GateApisImpl;
...
public final class GateClient {
    ...
    public Response<ApiResponseGateAddressData> getAddressWithResponse(String game, String region,
        RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Game.Genshin.Dispatch.Gate.GateApi.getAddress",
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ApiResponseGateAddressData getAddress(String game, String region) {
