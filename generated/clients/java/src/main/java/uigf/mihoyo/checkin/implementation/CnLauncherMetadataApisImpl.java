...
public final class CnLauncherMetadataApisImpl {
    ...
    public interface CnLauncherMetadataApisService {
        static CnLauncherMetadataApisService getNewInstance(HttpPipeline pipeline) {
            try {
                Class<?> clazz = Class.forName("uigf.mihoyo.checkin.implementation.CnLauncherMetadataApisServiceImpl");
    ...
    public Response<LauncherResponseJsonObject> getDeprecatedFileConfigsWithResponse(String launcherId, String language,
        ...
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Launcher.CN.MetadataApi.getDeprecatedFileConfigs", requestContext, updatedContext -> {
                final String accept = "application/json";
                String gameIdsConverted = (gameIds == null)
                    ? null
                    : gameIds.stream()
