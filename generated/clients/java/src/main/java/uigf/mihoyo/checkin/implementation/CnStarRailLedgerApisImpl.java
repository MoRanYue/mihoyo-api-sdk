...
public final class CnStarRailLedgerApisImpl {
    ...
    public interface CnStarRailLedgerApisService {
        static CnStarRailLedgerApisService getNewInstance(HttpPipeline pipeline) {
            try {
                Class<?> clazz = Class.forName("uigf.mihoyo.checkin.implementation.CnStarRailLedgerApisServiceImpl");
    ...
    public Response<ApiResponseJsonObject> getMonthDetailWithResponse(String cookie, int type, int currentPage,
        ...
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Game.CN.Events.StarRailLedgerApi.getMonthDetail", requestContext, updatedContext -> {
                final String accept = "application/json";
