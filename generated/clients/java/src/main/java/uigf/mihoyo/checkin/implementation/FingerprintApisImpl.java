...
public final class FingerprintApisImpl {
    ...
    public interface FingerprintApisService {
        static FingerprintApisService getNewInstance(HttpPipeline pipeline) {
            try {
                Class<?> clazz = Class.forName("uigf.mihoyo.checkin.implementation.FingerprintApisServiceImpl");
        ...
        Response<ApiResponseDeviceExtensionList> getExtensionList(@HostParam("endpoint") String endpoint,
            @QueryParam("app_name") String appName, @QueryParam("platform") String platform,
    ...
    public Response<ApiResponseDeviceExtensionList> getExtensionListWithResponse(String platform, String appName,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Utility.Device.FingerprintApi.getExtensionList",
            requestContext, updatedContext -> {
                ...
                return service.getExtensionList(this.client.getEndpoint(), appName, platform, accept, updatedContext);
            });
    }
