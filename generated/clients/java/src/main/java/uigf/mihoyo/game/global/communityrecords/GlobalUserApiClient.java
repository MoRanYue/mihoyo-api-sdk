...
import uigf.mihoyo.checkin.implementation.GlobalUserApisImpl;
...
public final class GlobalUserApiClient {
    ...
    public Response<ApiResponseCommunityUser> getFullInfoWithResponse(String cookie, String ds,
        ...
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Game.Global.CommunityRecords.UserApi.getFullInfo", requestContext,
            updatedContext -> this.serviceClient.getFullInfoWithResponse(cookie, ds, updatedContext));
    }
