...
import uigf.mihoyo.checkin.implementation.CnZenlessCultivationApisImpl;
...
public final class CnZenlessCultivationApiClient {
    ...
    public Response<ApiResponseJsonObject> getItemsWithResponse(String cookie, String uid, String region, int avatarId,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Game.CN.Events.ZenlessCultivationApi.getItems",
            requestContext,
    ...
    public Response<ApiResponseJsonObject> getIconInfoWithResponse(String cookie, String uid, String region,
        ...
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Game.CN.Events.ZenlessCultivationApi.getIconInfo", requestContext,
