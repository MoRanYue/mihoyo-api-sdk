package uigf.mihoyo.uncategorized.combotoken;
...
import uigf.mihoyo.checkin.implementation.ComboTokenApisImpl;
...
public final class ComboTokenClient {
    ...
    public Response<ApiResponseComboTokenUploadCredentials> exchangeWithResponse(ComboTokenRequest body,
        ...
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Uncategorized.ComboToken.ComboTokenApi.exchange", requestContext,
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ApiResponseComboTokenUploadCredentials exchange(ComboTokenRequest body) {
