...
public final class ShopApisImpl {
    ...
    public interface ShopApisService {
        static ShopApisService getNewInstance(HttpPipeline pipeline) {
            try {
                Class<?> clazz = Class.forName("uigf.mihoyo.checkin.implementation.ShopApisServiceImpl");
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        Response<ApiResponseCurrencyAndCountry> getCurrencyAndCountryByIp(@HostParam("endpoint") String endpoint,
