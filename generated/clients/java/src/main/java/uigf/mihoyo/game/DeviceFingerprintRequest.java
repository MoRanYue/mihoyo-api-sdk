...
public final class DeviceFingerprintRequest implements JsonSerializable<DeviceFingerprintRequest> {
    ...
    /*
     * The bbs_device_id property.
     */
    @Metadata(properties = { MetadataProperties.GENERATED })
    private String bbsDeviceId;
    ...
    /**
     * Get the bbsDeviceId property: The bbs_device_id property.
     * 
     * @return the bbsDeviceId value.
     */
    @Metadata(properties = { MetadataProperties.GENERATED })
    public String getBbsDeviceId() {
        return this.bbsDeviceId;
    }

    /**
     * Set the bbsDeviceId property: The bbs_device_id property.
     * 
     * @param bbsDeviceId the bbsDeviceId value to set.
     * @return the DeviceFingerprintRequest object itself.
     */
    @Metadata(properties = { MetadataProperties.GENERATED })
    public DeviceFingerprintRequest setBbsDeviceId(String bbsDeviceId) {
        this.bbsDeviceId = bbsDeviceId;
        return this;
    }
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("bbs_device_id", this.bbsDeviceId);
    ...
    public static DeviceFingerprintRequest fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                } else if ("bbs_device_id".equals(fieldName)) {
                    bbsDeviceId = reader.getString();
                } else {
                    if (additionalProperties == null) {
            ...
            deserializedDeviceFingerprintRequest.bbsDeviceId = bbsDeviceId;
