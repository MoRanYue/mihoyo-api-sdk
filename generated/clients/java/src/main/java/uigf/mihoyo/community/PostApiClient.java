...
import uigf.mihoyo.ApiResponsePost;
import uigf.mihoyo.ApiResponsePostList;
import uigf.mihoyo.checkin.implementation.PostApisImpl;
...
public final class PostApiClient {
    ...
    public Response<ApiResponsePost> getFullWithResponse(String postId, String cookie, String gids, Integer read,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Community.PostApi.getFull", requestContext,
    ...
    public Response<ApiResponsePost> getFullInCollectionWithResponse(String collectionId, String postId, String gids,
        RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Community.PostApi.getFullInCollection",
            requestContext, updatedContext -> this.serviceClient.getFullInCollectionWithResponse(collectionId, postId,
                gids, updatedContext));
    }
    ...
    public Response<ApiResponsePostList> getRepliesWithResponse(String postId, String lastId, Integer size, String gids,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Community.PostApi.getReplies", requestContext,
    ...
    public Response<ApiResponsePostList> getSubRepliesWithResponse(String postId, String replyId, String lastId,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Community.PostApi.getSubReplies",
            requestContext, updatedContext -> this.serviceClient.getSubRepliesWithResponse(postId, replyId, lastId,
                size, updatedContext));
    }
    ...
    public Response<ApiResponsePostList> getTopicPostsWithResponse(String gids, String topicId, Integer offset,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Community.PostApi.getTopicPosts",
            requestContext, updatedContext -> this.serviceClient.getTopicPostsWithResponse(gids, topicId, offset, size,
                lastId, updatedContext));
    }
    ...
    public Response<ApiResponsePostList> getUserPostsWithResponse(String uid, String gids, Integer offset, Integer size,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Community.PostApi.getUserPosts", requestContext,
    ...
    public Response<ApiResponsePostList> searchWithResponse(String gids, String keyword, Integer offset, Integer size,
        String lastId, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Community.PostApi.search", requestContext,
