...
public final class CnGameRecordsClientImpl {
    ...
    /**
     * The ZenlessMobileApisImpl object to access its operations.
     */
    private final ZenlessMobileApisImpl zenlessMobileApis;

    /**
     * Gets the ZenlessMobileApisImpl object to access its operations.
     * 
     * @return the ZenlessMobileApisImpl object.
     */
    public ZenlessMobileApisImpl getZenlessMobileApis() {
        return this.zenlessMobileApis;
    }
    ...
    public CnGameRecordsClientImpl(HttpPipeline httpPipeline, Instrumentation instrumentation, String endpoint) {
        ...
        this.zenlessMobileApis = new ZenlessMobileApisImpl(this);
    }
}
