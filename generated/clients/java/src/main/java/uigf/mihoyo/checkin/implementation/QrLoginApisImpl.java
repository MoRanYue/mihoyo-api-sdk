...
import uigf.mihoyo.ApiResponseAuthTicketLoginData;
import uigf.mihoyo.ApiResponseQrLoginStatus;
import uigf.mihoyo.ApiResponseQrLoginTicket;
import uigf.mihoyo.ApiResponseTokenInfo;
import uigf.mihoyo.passport.AuthTicketLoginRequest;
import uigf.mihoyo.passport.MobileCaptchaLoginRequest;
import uigf.mihoyo.passport.QrLoginCreateRequest;
import uigf.mihoyo.passport.QrLoginStatusRequest;
...
public final class QrLoginApisImpl {
    ...
    public interface QrLoginApisService {
        static QrLoginApisService getNewInstance(HttpPipeline pipeline) {
            try {
                Class<?> clazz = Class.forName("uigf.mihoyo.checkin.implementation.QrLoginApisServiceImpl");
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        Response<ApiResponseAuthTicketLoginData> loginByAuthTicket(@HostParam("endpoint") String endpoint,
            @HeaderParam("Content-Type") String contentType, @HeaderParam("Accept") String accept,
    ...
    public Response<ApiResponseQrLoginTicket> createWithResponse(QrLoginCreateRequest body,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Passport.QrLoginApi.create", requestContext,
            updatedContext -> {
    ...
    public Response<ApiResponseQrLoginStatus> getStatusWithResponse(QrLoginStatusRequest body,
        RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Passport.QrLoginApi.getStatus", requestContext,
            updatedContext -> {
                final String contentType = "application/json";
                final String accept = "application/json";
    ...
    public Response<ApiResponseTokenInfo> loginByMobileCaptchaWithResponse(MobileCaptchaLoginRequest body,
        RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Passport.QrLoginApi.loginByMobileCaptcha",
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ApiResponseAuthTicketLoginData> loginByAuthTicketWithResponse(AuthTicketLoginRequest body,
        RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Passport.QrLoginApi.loginByAuthTicket",
            requestContext, updatedContext -> {
                final String contentType = "application/json";
                final String accept = "application/json";
