...
import uigf.mihoyo.checkin.implementation.GlobalGenshinLedgerApisImpl;
...
public final class GlobalGenshinLedgerApiClient {
    ...
    public Response<ApiResponseJsonObject> getMonthInfoWithResponse(String cookie, String roleId, String server,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Game.Global.Genshin.LedgerApi.getMonthInfo",
    ...
    public Response<ApiResponseJsonObject> getMonthDetailWithResponse(String cookie, int type, int currentPage,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Game.Global.Genshin.LedgerApi.getMonthDetail",
