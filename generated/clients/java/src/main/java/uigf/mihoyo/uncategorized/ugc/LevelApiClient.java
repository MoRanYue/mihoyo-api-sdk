...
import uigf.mihoyo.checkin.implementation.LevelApisImpl;
...
public final class LevelApiClient {
    ...
    public Response<BinaryData> getIndexRedpointWithResponse(RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Uncategorized.UGC.LevelApi.getIndexRedpoint",
    ...
    public Response<BinaryData> getCollectionTinyInfoWithResponse(BinaryData body, long contentLength,
        ...
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Uncategorized.UGC.LevelApi.getCollectionTinyInfo", requestContext,
            updatedContext -> this.serviceClient.getCollectionTinyInfoWithResponse(body, contentLength,
                updatedContext));
    }
