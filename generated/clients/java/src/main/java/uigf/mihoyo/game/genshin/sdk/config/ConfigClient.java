package uigf.mihoyo.game.genshin.sdk.config;
...
import uigf.mihoyo.ApiResponseSdkComboConfigData;
import uigf.mihoyo.ApiResponseSdkGranterConfigData;
import uigf.mihoyo.ApiResponseSdkPrecacheConfigData;
import uigf.mihoyo.ApiResponseSdkShieldConfigData;
import uigf.mihoyo.checkin.implementation.GenshinSdkConfigApisImpl;
...
public final class ConfigClient {
    ...
    public Response<ApiResponseSdkComboConfigData> getComboWithResponse(String bizKey, String clientType,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Game.Genshin.SDK.Config.ConfigApi.getCombo",
            requestContext,
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ApiResponseSdkComboConfigData getCombo(String bizKey, String clientType, String rpcAppId,
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ApiResponseSdkComboConfigData getCombo(String bizKey, String clientType) {
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ApiResponseSdkPrecacheConfigData> getPrecacheWithResponse(String biz, String clientParam,
        String rpcAppId, String rpcAppVersion, String rpcChannelId, String rpcChannelVersion, String rpcClientType,
        String rpcComboVersion, String rpcDeviceFingerprint, String rpcDeviceId, String rpcDeviceModel,
        String rpcDeviceName, String rpcGameBiz, String rpcGoodsThirdParty, String rpcLanguage, String rpcMdkVersion,
        String rpcPaymentVersion, String rpcSdkVersion, String rpcSubChannelId, String rpcSystemVersion,
        RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Game.Genshin.SDK.Config.ConfigApi.getPrecache",
            requestContext,
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ApiResponseSdkPrecacheConfigData getPrecache(String biz, String clientParam, String rpcAppId,
        String rpcAppVersion, String rpcChannelId, String rpcChannelVersion, String rpcClientType,
        String rpcComboVersion, String rpcDeviceFingerprint, String rpcDeviceId, String rpcDeviceModel,
        String rpcDeviceName, String rpcGameBiz, String rpcGoodsThirdParty, String rpcLanguage, String rpcMdkVersion,
        String rpcPaymentVersion, String rpcSdkVersion, String rpcSubChannelId, String rpcSystemVersion) {
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ApiResponseSdkPrecacheConfigData getPrecache(String biz, String clientParam) {
        final String rpcAppId = null;
        final String rpcAppVersion = null;
        final String rpcChannelId = null;
        final String rpcChannelVersion = null;
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ApiResponseSdkGranterConfigData> getGranterConfigWithResponse(String appId, String channelId,
        ...
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Game.Genshin.SDK.Config.ConfigApi.getGranterConfig", requestContext,
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ApiResponseSdkGranterConfigData getGranterConfig(String appId, String channelId, String clientType,
        String rpcAppId, String rpcAppVersion, String rpcChannelId, String rpcChannelVersion, String rpcClientType,
        String rpcComboVersion, String rpcDeviceFingerprint, String rpcDeviceId, String rpcDeviceModel,
        String rpcDeviceName, String rpcGameBiz, String rpcGoodsThirdParty, String rpcLanguage, String rpcMdkVersion,
        String rpcPaymentVersion, String rpcSdkVersion, String rpcSubChannelId, String rpcSystemVersion) {
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ApiResponseSdkShieldConfigData> getShieldConfigWithResponse(String clientParam, String gameKey,
        String rpcAppId, String rpcAppVersion, String rpcChannelId, String rpcChannelVersion, String rpcClientType,
        String rpcComboVersion, String rpcDeviceFingerprint, String rpcDeviceId, String rpcDeviceModel,
        String rpcDeviceName, String rpcGameBiz, String rpcGoodsThirdParty, String rpcLanguage, String rpcMdkVersion,
        String rpcPaymentVersion, String rpcSdkVersion, String rpcSubChannelId, String rpcSystemVersion,
        RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Game.Genshin.SDK.Config.ConfigApi.getShieldConfig", requestContext,
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ApiResponseSdkShieldConfigData getShieldConfig(String clientParam, String gameKey, String rpcAppId,
        String rpcAppVersion, String rpcChannelId, String rpcChannelVersion, String rpcClientType,
        String rpcComboVersion, String rpcDeviceFingerprint, String rpcDeviceId, String rpcDeviceModel,
        String rpcDeviceName, String rpcGameBiz, String rpcGoodsThirdParty, String rpcLanguage, String rpcMdkVersion,
        String rpcPaymentVersion, String rpcSdkVersion, String rpcSubChannelId, String rpcSystemVersion) {
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ApiResponseSdkShieldConfigData getShieldConfig(String clientParam, String gameKey) {
        final String rpcAppId = null;
        final String rpcAppVersion = null;
        final String rpcChannelId = null;
        final String rpcChannelVersion = null;
