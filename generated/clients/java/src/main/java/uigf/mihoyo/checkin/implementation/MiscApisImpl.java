...
import uigf.mihoyo.community.VerificationCreateRequest;
import uigf.mihoyo.community.VerificationSubmitRequest;
...
public final class MiscApisImpl {
    ...
    public interface MiscApisService {
        static MiscApisService getNewInstance(HttpPipeline pipeline) {
            try {
                Class<?> clazz = Class.forName("uigf.mihoyo.checkin.implementation.MiscApisServiceImpl");
    ...
    public Response<ApiResponseJsonObject> getEmoticonSetWithResponse(RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Community.MiscApi.getEmoticonSet",
    ...
    public Response<ApiResponseJsonObject> createVerificationWithResponse(String cookie, VerificationCreateRequest body,
        RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Community.MiscApi.createVerification",
            requestContext, updatedContext -> {
    ...
    public Response<ApiResponseJsonObject> verifyVerificationWithResponse(String cookie, VerificationSubmitRequest body,
        RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Community.MiscApi.verifyVerification",
            requestContext, updatedContext -> {
                final String contentType = "application/json";
                final String accept = "application/json";
    ...
    public Response<ApiResponseJsonObject> getGeetestChallengeWithResponse(String cookie, String actionType,
        RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Community.MiscApi.getGeetestChallenge",
            requestContext, updatedContext -> {
                final String accept = "application/json";
