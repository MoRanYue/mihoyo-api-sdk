...
public final class GlobalZenlessLedgerApisImpl {
    ...
    public interface GlobalZenlessLedgerApisService {
        static GlobalZenlessLedgerApisService getNewInstance(HttpPipeline pipeline) {
            try {
                Class<?> clazz = Class.forName("uigf.mihoyo.checkin.implementation.GlobalZenlessLedgerApisServiceImpl");
    ...
    public Response<ApiResponseJsonObject> getMonthInfoWithResponse(String cookie, String roleId, String server,
        ...
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Game.Global.Records.ZenlessLedgerApi.getMonthInfo", requestContext, updatedContext -> {
    ...
    public Response<ApiResponseJsonObject> getMonthDetailWithResponse(String cookie, String type, int currentPage,
        ...
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Game.Global.Records.ZenlessLedgerApi.getMonthDetail", requestContext, updatedContext -> {
                final String accept = "application/json";
