...
public final class ZenlessApisImpl {
    ...
    public interface ZenlessApisService {
        static ZenlessApisService getNewInstance(HttpPipeline pipeline) {
            try {
                Class<?> clazz = Class.forName("uigf.mihoyo.checkin.implementation.ZenlessApisServiceImpl");
        ...
        Response<ApiResponseZenlessIndexData> getIndex(@HostParam("endpoint") String endpoint,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        Response<ApiResponseZenlessDailyNoteData> getDailyNote(@HostParam("endpoint") String endpoint,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        Response<ApiResponseZenlessShiyuDefenseData> getShiyuDefense(@HostParam("endpoint") String endpoint,
            @HeaderParam("Cookie") String cookie, @HeaderParam("DS") String ds,
            @QueryParam("without_v2_detail") Boolean withoutV2Detail, @QueryParam("schedule_type") Integer scheduleType,
            @QueryParam("need_detail") Boolean needDetail, @QueryParam("need_all") Boolean needAll,
            @QueryParam("server") String server, @QueryParam("role_id") String roleId,
            @HeaderParam("Accept") String accept, RequestContext requestContext);
    ...
    public Response<ApiResponseZenlessShiyuDefenseData> getShiyuDefenseWithResponse(String cookie, String server,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Game.CN.Records.ZenlessApi.getShiyuDefense",
            requestContext, updatedContext -> {
                final String accept = "application/json";
                return service.getShiyuDefense(this.client.getEndpoint(), cookie, ds, withoutV2Detail, scheduleType,
    ...
    public Response<ApiResponseJsonObject> getThresholdSimulationSummaryWithResponse(String cookie, String region,
        ...
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Game.CN.Records.ZenlessApi.getThresholdSimulationSummary", requestContext, updatedContext -> {
                final String accept = "application/json";
    ...
    public Response<ApiResponseJsonObject> getThresholdSimulationDetailWithResponse(String cookie, String region,
        ...
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Game.CN.Records.ZenlessApi.getThresholdSimulationDetail", requestContext, updatedContext -> {
                final String accept = "application/json";
