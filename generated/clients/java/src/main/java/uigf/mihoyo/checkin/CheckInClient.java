...
import uigf.mihoyo.checkin.implementation.CheckInApisImpl;
import uigf.mihoyo.community.LunaCheckInRequest;
...
public final class CheckInClient {
    ...
    public Response<ApiResponseJsonObject> getHomeWithResponse(String game, String cookie, String lang, String actId,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.CheckIn.CheckInApi.getHome", requestContext,
    ...
    public Response<ApiResponseJsonObject> getInfoWithResponse(String game, String cookie, String lang, String actId,
        String signGame, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.CheckIn.CheckInApi.getInfo", requestContext,
    ...
    public Response<ApiResponseJsonObject> signWithResponse(String game, String cookie, LunaCheckInRequest body,
        String signGame, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.CheckIn.CheckInApi.sign", requestContext,
    ...
    public Response<ApiResponseJsonObject> getResignInfoWithResponse(String game, String cookie, String lang,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.CheckIn.CheckInApi.getResignInfo",
            requestContext, updatedContext -> this.serviceClient.getResignInfoWithResponse(game, cookie, lang, actId,
                signGame, updatedContext));
    }
    ...
    public Response<ApiResponseJsonObject> resignWithResponse(String game, String cookie, LunaCheckInRequest body,
        String signGame, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.CheckIn.CheckInApi.resign", requestContext,
