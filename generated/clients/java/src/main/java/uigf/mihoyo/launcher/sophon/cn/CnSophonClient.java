package uigf.mihoyo.launcher.sophon.cn;
...
import uigf.mihoyo.checkin.implementation.CnSophonBuildApisImpl;
...
public final class CnSophonClient {
    ...
    public Response<ApiResponseJsonObject> getBuildWithResponse(String branch, String packageId, String password,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Launcher.Sophon.CN.BuildApi.getBuild",
    ...
    public Response<ApiResponseJsonObject> getPatchBuildWithResponse(String branch, String packageId, String password,
        String tag, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Launcher.Sophon.CN.BuildApi.getPatchBuild",
