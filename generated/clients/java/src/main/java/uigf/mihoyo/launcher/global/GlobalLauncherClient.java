package uigf.mihoyo.launcher.global;
...
import uigf.mihoyo.LauncherResponseGameBasicInfo;
import uigf.mihoyo.LauncherResponseJsonObject;
import uigf.mihoyo.checkin.implementation.GlobalLauncherMetadataApisImpl;
import uigf.mihoyo.launcher.DxConfigRequest;
...
public final class GlobalLauncherClient {
    ...
    public Response<LauncherResponseGameBasicInfo> getAllGameBasicInfoWithResponse(String launcherId, String language,
        ...
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Launcher.Global.MetadataApi.getAllGameBasicInfo", requestContext,
            updatedContext -> this.serviceClient.getAllGameBasicInfoWithResponse(launcherId, language, gameIds,
                updatedContext));
    }
    ...
    public Response<LauncherResponseJsonObject> getGamePackagesWithResponse(String launcherId, String language,
        List<String> gameIds, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Launcher.Global.MetadataApi.getGamePackages",
    ...
    public Response<LauncherResponseJsonObject> getGameChannelSdksWithResponse(String launcherId, String language,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Launcher.Global.MetadataApi.getGameChannelSdks",
    ...
    public Response<LauncherResponseJsonObject> getDeprecatedFileConfigsWithResponse(String launcherId, String language,
        Integer channel, Integer subChannel, List<String> gameIds, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Launcher.Global.MetadataApi.getDeprecatedFileConfigs", requestContext,
            updatedContext -> this.serviceClient.getDeprecatedFileConfigsWithResponse(launcherId, language, channel,
                subChannel, gameIds, updatedContext));
    }
    ...
    public Response<LauncherResponseJsonObject> getGameConfigsWithResponse(String launcherId, String language,
        List<String> gameIds, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Launcher.Global.MetadataApi.getGameConfigs",
    ...
    public Response<LauncherResponseJsonObject> getGameScanInfoWithResponse(String launcherId, String language,
        List<String> gameIds, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Launcher.Global.MetadataApi.getGameScanInfo",
    ...
    public Response<LauncherResponseJsonObject> getGameBranchesWithResponse(String launcherId, String language,
        List<String> gameIds, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Launcher.Global.MetadataApi.getGameBranches",
    ...
    public Response<LauncherResponseJsonObject> getWpfPackagesWithResponse(String launcherId, String language,
        List<String> gameIds, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Launcher.Global.MetadataApi.getWpfPackages",
    ...
    public Response<LauncherResponseJsonObject> getDxConfigsWithResponse(String launcherId, String language,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Launcher.Global.MetadataApi.getDxConfigs",
