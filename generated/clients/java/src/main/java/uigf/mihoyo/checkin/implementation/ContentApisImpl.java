...
import uigf.mihoyo.ApiResponseAnnouncementContentData;
...
public final class ContentApisImpl {
    ...
    public interface ContentApisService {
        static ContentApisService getNewInstance(HttpPipeline pipeline) {
            try {
                Class<?> clazz = Class.forName("uigf.mihoyo.checkin.implementation.ContentApisServiceImpl");
        ...
        Response<ApiResponseAnnouncementContentData> get(@HostParam("endpoint") String endpoint,
            @QueryParam("t") String t, @QueryParam("game") String game, @QueryParam("game_biz") String gameBiz,
            @QueryParam("lang") String lang, @QueryParam("bundle_id") String bundleId,
            @QueryParam("platform") ListRequestPlatform platform, @QueryParam("region") String region,
            @QueryParam("level") Integer level, @QueryParam("uid") String uid,
    ...
    public Response<ApiResponseAnnouncementContentData> getWithResponse(String game, String gameBiz, String lang,
        ...
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Game.Genshin.AnnouncementContent.ContentApi.get", requestContext, updatedContext -> {
