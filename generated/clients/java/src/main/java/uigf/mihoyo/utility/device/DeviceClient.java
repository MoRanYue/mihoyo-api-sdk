package uigf.mihoyo.utility.device;
...
import uigf.mihoyo.ApiResponseDeviceExtensionList;
import uigf.mihoyo.ApiResponseDeviceFingerprint;
import uigf.mihoyo.checkin.implementation.FingerprintApisImpl;
import uigf.mihoyo.game.DeviceFingerprintRequest;
...
public final class DeviceClient {
     ...
     * @param appName The appName parameter.
    ...
    public Response<ApiResponseDeviceExtensionList> getExtensionListWithResponse(String platform, String appName,
        RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Utility.Device.FingerprintApi.getExtensionList",
            requestContext,
            updatedContext -> this.serviceClient.getExtensionListWithResponse(platform, appName, updatedContext));
    }
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ApiResponseDeviceExtensionList getExtensionList(String platform, String appName) {
        return getExtensionListWithResponse(platform, appName, RequestContext.none()).getValue();
    }
    ...
    public Response<ApiResponseDeviceFingerprint> getFingerprintWithResponse(String appVersion, String clientType,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Utility.Device.FingerprintApi.getFingerprint",
