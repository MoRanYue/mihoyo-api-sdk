...
public final class AuthKeyApiClient {
    ...
    public Response<ApiResponseAuthKeyData> generateWithResponse(String cookie, AuthKeyRequest body, String ds,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Game.CN.MiYouSheAccount.AuthKeyApi.generate",
            requestContext,
            updatedContext -> this.serviceClient.generateWithResponse(cookie, body, ds, updatedContext));
    }
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ApiResponseAuthKeyData generate(String cookie, AuthKeyRequest body, String ds) {
        return generateWithResponse(cookie, body, ds, RequestContext.none()).getValue();
    }
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ApiResponseAuthKeyData generate(String cookie, AuthKeyRequest body) {
