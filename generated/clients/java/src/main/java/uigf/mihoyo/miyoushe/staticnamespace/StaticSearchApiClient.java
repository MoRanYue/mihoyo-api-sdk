...
import uigf.mihoyo.checkin.implementation.StaticSearchApisImpl;

/**
 * Initializes a new instance of the synchronous StaticClient type.
 */
@ServiceClient(builder = StaticClientBuilder.class)
public final class StaticSearchApiClient {
    @Metadata(properties = { MetadataProperties.GENERATED })
    private final StaticSearchApisImpl serviceClient;

    private final Instrumentation instrumentation;

    /**
     * Initializes an instance of StaticSearchApiClient class.
     * 
     * @param serviceClient the service client implementation.
     * @param instrumentation the instrumentation instance.
     */
    @Metadata(properties = { MetadataProperties.GENERATED })
    StaticSearchApiClient(StaticSearchApisImpl serviceClient, Instrumentation instrumentation) {
