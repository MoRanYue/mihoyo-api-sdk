package uigf.mihoyo.game.genshin.dispatch.regionlist;
...
import uigf.mihoyo.checkin.implementation.RegionListApisImpl;
...
public final class RegionListClient {
    ...
    public Response<BinaryData> queryWithResponse(String binary, String channelId, String lang, String platform,
        ...
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Game.Genshin.Dispatch.RegionList.RegionListApi.query", requestContext,
            updatedContext -> this.serviceClient.queryWithResponse(binary, channelId, lang, platform, subChannelId,
                time, version, updatedContext));
    }
