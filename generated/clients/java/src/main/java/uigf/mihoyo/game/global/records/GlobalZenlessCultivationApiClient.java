...
import uigf.mihoyo.checkin.implementation.GlobalZenlessCultivationApisImpl;
...
public final class GlobalZenlessCultivationApiClient {
    ...
    public Response<ApiResponseJsonObject> getItemsWithResponse(String cookie, String uid, String region, int avatarId,
        ...
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Game.Global.Records.ZenlessCultivationApi.getItems", requestContext,
    ...
    public Response<ApiResponseJsonObject> getIconInfoWithResponse(String cookie, String uid, String region,
        RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Game.Global.Records.ZenlessCultivationApi.getIconInfo", requestContext,
