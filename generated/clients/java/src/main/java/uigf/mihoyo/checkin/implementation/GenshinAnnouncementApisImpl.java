...
public final class GenshinAnnouncementApisImpl {
    ...
    public interface GenshinAnnouncementApisService {
        static GenshinAnnouncementApisService getNewInstance(HttpPipeline pipeline) {
            try {
                Class<?> clazz = Class.forName("uigf.mihoyo.checkin.implementation.GenshinAnnouncementApisServiceImpl");
        ...
        Response<ApiResponseAnnouncementListData> list(@HostParam("endpoint") String endpoint,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        Response<ApiResponseAnnouncementAlertData> getAlert(@HostParam("endpoint") String endpoint,
            @QueryParam("game") String game, @QueryParam("game_biz") String gameBiz, @QueryParam("lang") String lang,
            @QueryParam("bundle_id") String bundleId, @QueryParam("platform") ListRequestPlatform platform,
            @QueryParam("region") String region, @QueryParam("level") Integer level, @QueryParam("uid") String uid,
            @QueryParam("channel_id") Integer channelId, @HeaderParam("Accept") String accept,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        Response<ApiResponseAnnouncementPictureData> getAlertPicture(@HostParam("endpoint") String endpoint,
            @QueryParam("game") String game, @QueryParam("game_biz") String gameBiz, @QueryParam("lang") String lang,
            @QueryParam("bundle_id") String bundleId, @QueryParam("platform") ListRequestPlatform platform,
            @QueryParam("region") String region, @QueryParam("level") Integer level, @QueryParam("uid") String uid,
            @QueryParam("channel_id") Integer channelId, @HeaderParam("Accept") String accept,
    ...
    public Response<ApiResponseAnnouncementListData> listWithResponse(String game, String gameBiz, String lang,
        ...
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Game.Genshin.Announcements.AnnouncementApi.list", requestContext, updatedContext -> {
    ...
    public Response<ApiResponseAnnouncementAlertData> getAlertWithResponse(String game, String gameBiz, String lang,
        ...
        RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Game.Genshin.Announcements.AnnouncementApi.getAlert", requestContext, updatedContext -> {
                final String accept = "application/json";
