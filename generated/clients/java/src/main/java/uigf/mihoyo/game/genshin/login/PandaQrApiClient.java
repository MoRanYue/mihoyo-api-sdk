...
import uigf.mihoyo.ApiResponsePandaQrResponse;
import uigf.mihoyo.checkin.implementation.PandaQrApisImpl;
import uigf.mihoyo.game.PandaQrRequest;
...
public final class PandaQrApiClient {
    ...
    public Response<ApiResponsePandaQrResponse> createWithResponse(PandaQrRequest body, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Game.Genshin.Login.PandaQrApi.create",
            requestContext, updatedContext -> this.serviceClient.createWithResponse(body, updatedContext));
    }
    ...
    public Response<ApiResponsePandaQrResponse> getStatusWithResponse(PandaQrRequest body,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Game.Genshin.Login.PandaQrApi.getStatus",
