package uigf.mihoyo.game.genshin.sdk.secure;
...
import uigf.mihoyo.ApiResponseSdkProtocolVersionComparisonData;
import uigf.mihoyo.ApiResponseSdkRedDotData;
import uigf.mihoyo.checkin.implementation.GenshinSdkSecureApisImpl;
import uigf.mihoyo.game.genshin.sdk.ProtocolVersionRequest;
import uigf.mihoyo.game.genshin.sdk.RedDotRequest;
...
public final class SecureClient {
    ...
    public Response<ApiResponseSdkProtocolVersionComparisonData> compareProtocolVersionWithResponse(
        ProtocolVersionRequest body, String rpcAppId, String rpcAppVersion, String rpcChannelId,
        String rpcChannelVersion, String rpcClientType, String rpcComboVersion, String rpcDeviceFingerprint,
        String rpcDeviceId, String rpcDeviceModel, String rpcDeviceName, String rpcGameBiz, String rpcGoodsThirdParty,
        String rpcLanguage, String rpcMdkVersion, String rpcPaymentVersion, String rpcSdkVersion,
        String rpcSubChannelId, String rpcSystemVersion, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Game.Genshin.SDK.Secure.SecureApi.compareProtocolVersion", requestContext,
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ApiResponseSdkProtocolVersionComparisonData compareProtocolVersion(ProtocolVersionRequest body,
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Response<ApiResponseSdkRedDotData> getRedDotsWithResponse(RedDotRequest body, String rpcAppId,
        String rpcAppVersion, String rpcChannelId, String rpcChannelVersion, String rpcClientType,
        String rpcComboVersion, String rpcDeviceFingerprint, String rpcDeviceId, String rpcDeviceModel,
        String rpcDeviceName, String rpcGameBiz, String rpcGoodsThirdParty, String rpcLanguage, String rpcMdkVersion,
        String rpcPaymentVersion, String rpcSdkVersion, String rpcSubChannelId, String rpcSystemVersion,
        RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Game.Genshin.SDK.Secure.SecureApi.getRedDots",
            requestContext,
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ApiResponseSdkRedDotData getRedDots(RedDotRequest body, String rpcAppId, String rpcAppVersion,
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ApiResponseSdkRedDotData getRedDots(RedDotRequest body) {
        final String rpcAppId = null;
        final String rpcAppVersion = null;
        final String rpcChannelId = null;
        final String rpcChannelVersion = null;
