...
public final class GenshinSdkConfigApisImpl {
    ...
    public interface GenshinSdkConfigApisService {
        static GenshinSdkConfigApisService getNewInstance(HttpPipeline pipeline) {
            try {
                Class<?> clazz = Class.forName("uigf.mihoyo.checkin.implementation.GenshinSdkConfigApisServiceImpl");
        ...
        Response<ApiResponseSdkComboConfigData> getCombo(@HostParam("endpoint") String endpoint,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        Response<ApiResponseSdkPrecacheConfigData> getPrecache(@HostParam("endpoint") String endpoint,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        Response<ApiResponseSdkGranterConfigData> getGranterConfig(@HostParam("endpoint") String endpoint,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        Response<ApiResponseSdkShieldConfigData> getShieldConfig(@HostParam("endpoint") String endpoint,
    ...
    public Response<ApiResponseSdkGranterConfigData> getGranterConfigWithResponse(String appId, String channelId,
        ...
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Game.Genshin.SDK.Config.ConfigApi.getGranterConfig", requestContext, updatedContext -> {
                final String accept = "application/json";
    ...
    public Response<ApiResponseSdkShieldConfigData> getShieldConfigWithResponse(String clientParam, String gameKey,
        ...
        RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Game.Genshin.SDK.Config.ConfigApi.getShieldConfig", requestContext, updatedContext -> {
                final String accept = "application/json";
