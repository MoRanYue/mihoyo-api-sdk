...
import uigf.mihoyo.passport.GameTokenRequest;
import uigf.mihoyo.passport.TokenExchangeRequest;
...
public final class PassportSessionApisImpl {
    ...
    public interface PassportSessionApisService {
        static PassportSessionApisService getNewInstance(HttpPipeline pipeline) {
            try {
                Class<?> clazz = Class.forName("uigf.mihoyo.checkin.implementation.PassportSessionApisServiceImpl");
    ...
    public Response<ApiResponseTokenInfo> getTokenByGameTokenWithResponse(GameTokenRequest body,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Passport.SessionApi.getTokenByGameToken",
    ...
    public Response<ApiResponseTokenInfo> exchangeWithResponse(TokenExchangeRequest body,
        RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Passport.SessionApi.exchange", requestContext,
            updatedContext -> {
                final String contentType = "application/json";
                final String accept = "application/json";
