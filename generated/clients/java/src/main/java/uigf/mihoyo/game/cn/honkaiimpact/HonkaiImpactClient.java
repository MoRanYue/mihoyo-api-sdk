package uigf.mihoyo.game.cn.honkaiimpact;
...
import uigf.mihoyo.checkin.implementation.DailyNoteApisImpl;
...
public final class HonkaiImpactClient {
    ...
    public Response<ApiResponseJsonObject> getDailyNoteWithResponse(String cookie, String server, String roleId,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Game.CN.HonkaiImpact.DailyNoteApi.getDailyNote",
            requestContext,
