...
import uigf.mihoyo.api.request.LegacyCrashReport;
...
public final class CrashApisImpl {
    ...
    public interface CrashApisService {
        static CrashApisService getNewInstance(HttpPipeline pipeline) {
            try {
                Class<?> clazz = Class.forName("uigf.mihoyo.checkin.implementation.CrashApisServiceImpl");
        ...
        Response<Void> upload(@HostParam("endpoint") String endpoint, @HeaderParam("Content-Type") String contentType,
            @BodyParam("application/json") LegacyCrashReport body, RequestContext requestContext);
    }
    ...
    public Response<Void> uploadWithResponse(LegacyCrashReport body, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Uncategorized.Telemetry.Crash.CrashApi.upload",
