...
public final class GenshinSdkSecureApisImpl {
    ...
    public interface GenshinSdkSecureApisService {
        static GenshinSdkSecureApisService getNewInstance(HttpPipeline pipeline) {
            try {
                Class<?> clazz = Class.forName("uigf.mihoyo.checkin.implementation.GenshinSdkSecureApisServiceImpl");
        ...
        Response<ApiResponseSdkProtocolVersionComparisonData> compareProtocolVersion(
            @HostParam("endpoint") String endpoint, @HeaderParam("x-rpc-app_id") String rpcAppId,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        Response<ApiResponseSdkRedDotData> getRedDots(@HostParam("endpoint") String endpoint,
    ...
    public Response<ApiResponseSdkProtocolVersionComparisonData> compareProtocolVersionWithResponse(
        ...
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Game.Genshin.SDK.Secure.SecureApi.compareProtocolVersion", requestContext, updatedContext -> {
