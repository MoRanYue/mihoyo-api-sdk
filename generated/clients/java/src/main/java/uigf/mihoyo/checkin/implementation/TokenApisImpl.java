...
public final class TokenApisImpl {
    ...
    public interface TokenApisService {
        static TokenApisService getNewInstance(HttpPipeline pipeline) {
            try {
                Class<?> clazz = Class.forName("uigf.mihoyo.checkin.implementation.TokenApisServiceImpl");
        ...
        Response<ApiResponseUgcTokenInfo> get(@HostParam("endpoint") String endpoint,
