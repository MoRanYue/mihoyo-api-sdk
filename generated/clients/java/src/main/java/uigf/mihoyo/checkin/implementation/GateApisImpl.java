...
public final class GateApisImpl {
    ...
    public interface GateApisService {
        static GateApisService getNewInstance(HttpPipeline pipeline) {
            try {
                Class<?> clazz = Class.forName("uigf.mihoyo.checkin.implementation.GateApisServiceImpl");
        ...
        Response<ApiResponseGateAddressData> getAddress(@HostParam("endpoint") String endpoint,
