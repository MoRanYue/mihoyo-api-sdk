...
import uigf.mihoyo.checkin.implementation.PassportClientImpl;
...
public final class PassportClientBuilder implements HttpTrait<PassportClientBuilder>, ProxyTrait<PassportClientBuilder>,
    ...
    /**
     * Builds an instance of WebSessionApiClient class.
     * 
     * @return an instance of WebSessionApiClient.
     */
    @Metadata(properties = { MetadataProperties.GENERATED })
    public WebSessionApiClient buildWebSessionApiClient() {
        PassportClientImpl innerClient = buildInnerClient();
        return new WebSessionApiClient(innerClient.getWebSessionApis(), innerClient.getInstrumentation());
    }
