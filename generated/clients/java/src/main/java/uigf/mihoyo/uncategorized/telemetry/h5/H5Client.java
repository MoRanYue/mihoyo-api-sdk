package uigf.mihoyo.uncategorized.telemetry.h5;
...
import uigf.mihoyo.checkin.implementation.H5BatchApisImpl;
...
public final class H5Client {
    ...
    private final H5BatchApisImpl serviceClient;
     ...
     */
    @Metadata(properties = { MetadataProperties.GENERATED })
    H5Client(H5BatchApisImpl serviceClient, Instrumentation instrumentation) {
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ApiResponse upload(String topic, H5LogRequest body, String date) {
