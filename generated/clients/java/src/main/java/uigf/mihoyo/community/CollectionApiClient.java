...
import uigf.mihoyo.checkin.implementation.CollectionApisImpl;
...
public final class CollectionApiClient {
    ...
    public Response<ApiResponseJsonObject> getDetailWithResponse(int gids, String id, String ds,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Community.CollectionApi.getDetail",
            requestContext, updatedContext -> this.serviceClient.getDetailWithResponse(gids, id, ds, updatedContext));
    }
