...
public final class RecordClientImpl {
    ...
    /**
     * The GcgApisImpl object to access its operations.
     */
    private final GcgApisImpl gcgApis;

    /**
     * Gets the GcgApisImpl object to access its operations.
     * 
     * @return the GcgApisImpl object.
     */
    public GcgApisImpl getGcgApis() {
        return this.gcgApis;
    }
    ...
    public RecordClientImpl(HttpPipeline httpPipeline, Instrumentation instrumentation, String endpoint) {
        ...
        this.gcgApis = new GcgApisImpl(this);
