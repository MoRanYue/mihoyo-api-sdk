...
public final class GameTelemetryUploadApisImpl {
    ...
    public interface GameTelemetryUploadApisService {
        static GameTelemetryUploadApisService getNewInstance(HttpPipeline pipeline) {
            try {
                Class<?> clazz = Class.forName("uigf.mihoyo.checkin.implementation.GameTelemetryUploadApisServiceImpl");
        ...
        Response<UploadResponse> uploadCrash(@HostParam("endpoint") String endpoint,
            ...
            @BodyParam("application/json") List<GameCrashTelemetryEvent> body, RequestContext requestContext);
        ...
        Response<UploadResponse> uploadSdk(@HostParam("endpoint") String endpoint,
            ...
            @HeaderParam("DATE") String date, @HeaderParam("cms-signature") String cmsSignature,
            @HeaderParam("Content-Type") String contentType, @HeaderParam("Accept") String accept,
            @BodyParam("application/json") List<GameSdkTelemetryEvent> body, RequestContext requestContext);
        ...
        Response<UploadResponse> uploadCustom(@HostParam("endpoint") String endpoint,
            ...
            @HeaderParam("DATE") String date, @HeaderParam("cms-signature") String cmsSignature,
            @HeaderParam("Content-Type") String contentType, @HeaderParam("Accept") String accept,
            @BodyParam("application/json") List<GameCustomTelemetryEvent> body, RequestContext requestContext);
    }
    ...
    public Response<UploadResponse> uploadCrashWithResponse(List<GameCrashTelemetryEvent> body, String authorization,
        ...
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Uncategorized.Telemetry.Game.UploadApi.uploadCrash", requestContext, updatedContext -> {
    ...
    public Response<UploadResponse> uploadSdkWithResponse(List<GameSdkTelemetryEvent> body, String authorization,
        String contentMd5, String date, String cmsSignature, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Uncategorized.Telemetry.Game.UploadApi.uploadSdk", requestContext, updatedContext -> {
                final String contentType = "application/json";
                final String accept = "application/json";
    ...
    public Response<UploadResponse> uploadCustomWithResponse(List<GameCustomTelemetryEvent> body, String authorization,
        String contentMd5, String date, String cmsSignature, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Uncategorized.Telemetry.Game.UploadApi.uploadCustom", requestContext, updatedContext -> {
                final String contentType = "application/json";
                final String accept = "application/json";
