...
import uigf.mihoyo.checkin.implementation.QrLoginApisImpl;
...
public final class QrLoginApiClient {
    ...
    public Response<ApiResponseAuthTicketLoginData> loginByAuthTicketWithResponse(AuthTicketLoginRequest body,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Passport.QrLoginApi.loginByAuthTicket",
            requestContext, updatedContext -> this.serviceClient.loginByAuthTicketWithResponse(body, updatedContext));
    }
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ApiResponseAuthTicketLoginData loginByAuthTicket(AuthTicketLoginRequest body) {
