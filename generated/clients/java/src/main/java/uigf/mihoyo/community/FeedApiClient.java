...
import uigf.mihoyo.checkin.implementation.FeedApisImpl;
...
public final class FeedApiClient {
    ...
    public Response<ApiResponsePostList> getNewsWithResponse(String gids, Integer offset, Integer size, String lastId,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Community.FeedApi.getNews", requestContext,
    ...
    public Response<ApiResponsePostList> getHotForumPostsWithResponse(String gids, Integer offset, Integer size,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Community.FeedApi.getHotForumPosts",
            requestContext, updatedContext -> this.serviceClient.getHotForumPostsWithResponse(gids, offset, size,
    ...
    public Response<ApiResponsePostList> getRecentForumPostsWithResponse(String gids, Integer offset, Integer size,
        String lastId, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Community.FeedApi.getRecentForumPosts",
            requestContext, updatedContext -> this.serviceClient.getRecentForumPostsWithResponse(gids, offset, size,
                lastId, updatedContext));
    }
    ...
    public Response<ApiResponsePostList> getTimelineWithResponse(String gids, Integer offset, Integer size,
        String lastId, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Community.FeedApi.getTimeline", requestContext,
    ...
    public Response<ApiResponseJsonObject> getLotteryUserShowWithResponse(String lotteryId,
        RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Community.FeedApi.getLotteryUserShow",
            requestContext,
