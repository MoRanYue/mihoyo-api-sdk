...
public final class GranterApisImpl {
    ...
    public interface GranterApisService {
        static GranterApisService getNewInstance(HttpPipeline pipeline) {
            try {
                Class<?> clazz = Class.forName("uigf.mihoyo.checkin.implementation.GranterApisServiceImpl");
        ...
        Response<ApiResponseGranterLoginData> login(@HostParam("endpoint") String endpoint,
