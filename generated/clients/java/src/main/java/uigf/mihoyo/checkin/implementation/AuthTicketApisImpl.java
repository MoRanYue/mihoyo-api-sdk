...
import uigf.mihoyo.passport.AuthTicketRequest;
...
public final class AuthTicketApisImpl {
    ...
    public interface AuthTicketApisService {
        static AuthTicketApisService getNewInstance(HttpPipeline pipeline) {
            try {
                Class<?> clazz = Class.forName("uigf.mihoyo.checkin.implementation.AuthTicketApisServiceImpl");
    ...
    public Response<ApiResponseTokenInfo> createByGameBizWithResponse(AuthTicketRequest body,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Passport.AuthTicketApi.createByGameBiz",
