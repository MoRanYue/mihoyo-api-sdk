package uigf.mihoyo.utility.livestream;
...
import uigf.mihoyo.checkin.implementation.RedemptionCodeApisImpl;
...
public final class LiveStreamClient {
    ...
    public Response<ApiResponseJsonObject> refreshWithResponse(String activityId, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Utility.LiveStream.RedemptionCodeApi.refresh",
