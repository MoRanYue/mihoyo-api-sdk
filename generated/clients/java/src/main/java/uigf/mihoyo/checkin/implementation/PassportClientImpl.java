...
public final class PassportClientImpl {
    ...
    /**
     * The WebSessionApisImpl object to access its operations.
     */
    private final WebSessionApisImpl webSessionApis;

    /**
     * Gets the WebSessionApisImpl object to access its operations.
     * 
     * @return the WebSessionApisImpl object.
     */
    public WebSessionApisImpl getWebSessionApis() {
        return this.webSessionApis;
    }
    ...
    public PassportClientImpl(HttpPipeline httpPipeline, Instrumentation instrumentation, String endpoint) {
        ...
        this.webSessionApis = new WebSessionApisImpl(this);
