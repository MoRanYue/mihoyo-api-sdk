...
public final class GachaItem implements JsonSerializable<GachaItem> {
    ...
    /*
     * The op_gacha_type property.
     */
    @Metadata(properties = { MetadataProperties.GENERATED })
    private String opGachaType;
    ...
    /**
     * Get the opGachaType property: The op_gacha_type property.
     * 
     * @return the opGachaType value.
     */
    @Metadata(properties = { MetadataProperties.GENERATED })
    public String getOpGachaType() {
        return this.opGachaType;
    }
    ...
    public JsonWriter toJson(JsonWriter jsonWriter) throws IOException {
        ...
        jsonWriter.writeStringField("op_gacha_type", this.opGachaType);
    ...
    public static GachaItem fromJson(JsonReader jsonReader) throws IOException {
        return jsonReader.readObject(reader -> {
            ...
            while (reader.nextToken() != JsonToken.END_OBJECT) {
                ...
                } else if ("op_gacha_type".equals(fieldName)) {
                    opGachaType = reader.getString();
            ...
            deserializedGachaItem.lang = lang;
            deserializedGachaItem.opGachaType = opGachaType;
