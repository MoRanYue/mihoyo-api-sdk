package uigf.mihoyo.game.genshin.login;
...
import uigf.mihoyo.ApiResponseGranterLoginData;
import uigf.mihoyo.checkin.implementation.GranterApisImpl;
import uigf.mihoyo.game.genshin.sdk.GranterLoginRequest;
...
public final class GranterApiClient {
    ...
    public Response<ApiResponseGranterLoginData> loginWithResponse(GranterLoginRequest body, String rpcAppId,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Game.Genshin.Login.GranterApi.login",
            requestContext,
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ApiResponseGranterLoginData login(GranterLoginRequest body, String rpcAppId, String rpcAppVersion,
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ApiResponseGranterLoginData login(GranterLoginRequest body) {
