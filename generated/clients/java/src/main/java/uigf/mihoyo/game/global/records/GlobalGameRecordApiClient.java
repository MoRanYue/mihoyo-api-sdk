package uigf.mihoyo.game.global.records;
...
import uigf.mihoyo.checkin.implementation.GlobalGameRecordApisImpl;
...
public final class GlobalGameRecordApiClient {
    ...
    public Response<ApiResponseJsonObject> getGenshinIndexWithResponse(String cookie, String server, String roleId,
        ...
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Game.Global.Records.GameRecordApi.getGenshinIndex", requestContext,
            updatedContext -> this.serviceClient.getGenshinIndexWithResponse(cookie, server, roleId, ds, avatarListType,
                updatedContext));
    }
    ...
    public Response<ApiResponseJsonObject> getGenshinDailyNoteWithResponse(String cookie, String server, String roleId,
        ...
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Game.Global.Records.GameRecordApi.getGenshinDailyNote", requestContext,
            updatedContext -> this.serviceClient.getGenshinDailyNoteWithResponse(cookie, server, roleId, ds,
                updatedContext));
    }
    ...
    public Response<ApiResponseJsonObject> getStarRailIndexWithResponse(String cookie, String server, String roleId,
        String ds, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Game.Global.Records.GameRecordApi.getStarRailIndex", requestContext,
            updatedContext -> this.serviceClient.getStarRailIndexWithResponse(cookie, server, roleId, ds,
                updatedContext));
    }
    ...
    public Response<ApiResponseJsonObject> getStarRailDailyNoteWithResponse(String cookie, String server, String roleId,
        String ds, RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Game.Global.Records.GameRecordApi.getStarRailDailyNote", requestContext,
    ...
    public Response<ApiResponseJsonObject> getStarRailChallengePeakWithResponse(String cookie, String server,
        ...
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Game.Global.Records.GameRecordApi.getStarRailChallengePeak", requestContext,
