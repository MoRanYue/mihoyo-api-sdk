package uigf.mihoyo.uncategorized.ugc;
...
import uigf.mihoyo.ApiResponseUgcTokenInfo;
import uigf.mihoyo.checkin.implementation.TokenApisImpl;
...
public final class TokenApiClient {
    ...
    public Response<ApiResponseUgcTokenInfo> getWithResponse(String authkey, String authAppid, String lang,
        RequestContext requestContext) {
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Uncategorized.UGC.TokenApi.get", requestContext,
    ...
    @Metadata(properties = { MetadataProperties.GENERATED })
    @ServiceMethod(returns = ReturnType.SINGLE)
    public ApiResponseUgcTokenInfo get(String authkey, String authAppid, String lang) {
