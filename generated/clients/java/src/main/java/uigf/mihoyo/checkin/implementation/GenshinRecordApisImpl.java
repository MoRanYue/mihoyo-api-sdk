...
public final class GenshinRecordApisImpl {
    ...
    public interface GenshinRecordApisService {
        static GenshinRecordApisService getNewInstance(HttpPipeline pipeline) {
            try {
                Class<?> clazz = Class.forName("uigf.mihoyo.checkin.implementation.GenshinRecordApisServiceImpl");
        ...
        Response<ApiResponseGenshinRecordIndexData> getIndex(@HostParam("endpoint") String endpoint,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        Response<ApiResponseGenshinDailyNoteData> getDailyNote(@HostParam("endpoint") String endpoint,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        Response<ApiResponseGenshinSpiralAbyssData> getSpiralAbyss(@HostParam("endpoint") String endpoint,
            @HeaderParam("Cookie") String cookie, @HeaderParam("DS") String ds,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        Response<ApiResponseGenshinTheaterData> getImaginariumTheater(@HostParam("endpoint") String endpoint,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        Response<ApiResponseGenshinCharacterMasterData> getCharacterMaster(@HostParam("endpoint") String endpoint,
            @HeaderParam("Cookie") String cookie, @HeaderParam("DS") String ds, @QueryParam("server") String server,
            @QueryParam("role_id") String roleId, @HeaderParam("Accept") String accept, RequestContext requestContext);
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        Response<ApiResponseGenshinStygianData> getStygianOnslaught(@HostParam("endpoint") String endpoint,
            @HeaderParam("Cookie") String cookie, @HeaderParam("DS") String ds,
            @QueryParam("schedule_type") Integer scheduleType, @QueryParam("need_detail") Boolean needDetail,
            @QueryParam("need_all") Boolean needAll, @QueryParam("server") String server,
            @QueryParam("role_id") String roleId, @HeaderParam("Accept") String accept, RequestContext requestContext);
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        Response<ApiResponseGenshinStygianPopularityData> getStygianPopularity(@HostParam("endpoint") String endpoint,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        Response<ApiResponseGenshinActivityCalendarData> getActivityCalendar(@HostParam("endpoint") String endpoint,
            @HeaderParam("Cookie") String cookie, @HeaderParam("DS") String ds,
        ...
        @HttpRequestInformation(
            method = HttpMethod.GET,
            path = "/game_record/app/genshin/api/external_content",
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        Response<ApiResponseGenshinExternalContentData> getExternalContent(@HostParam("endpoint") String endpoint,
            @HeaderParam("Cookie") String cookie, @HeaderParam("DS") String ds, @QueryParam("item_id") long itemId,
            @QueryParam("item_type") int itemType, @HeaderParam("Accept") String accept, RequestContext requestContext);

        @HttpRequestInformation(
            method = HttpMethod.GET,
            path = "/game_record/app/genshin/api/roleBasicInfo",
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        Response<ApiResponseGenshinRoleBasicInfoData> getRoleBasicInfo(@HostParam("endpoint") String endpoint,
        ...
        @HttpRequestInformation(
            ...
            expectedStatusCodes = { 200 })
        @UnexpectedResponseExceptionDetail
        Response<ApiResponseGenshinToolData> getTool(@HostParam("endpoint") String endpoint,
            @HeaderParam("Cookie") String cookie, @HeaderParam("DS") String ds,
            @HeaderParam("x-rpc-challenge") String challenge, @HeaderParam("Accept") String accept,
            RequestContext requestContext);
    }
    ...
    public Response<ApiResponseGenshinStygianPopularityData> getStygianPopularityWithResponse(String server,
        ...
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Game.Genshin.Record.GameRecordApi.getStygianPopularity", requestContext, updatedContext -> {
                final String accept = "application/json";
    ...
    public Response<ApiResponseGenshinExternalContentData> getExternalContentWithResponse(String cookie, String ds,
        ...
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Game.Genshin.Record.GameRecordApi.getExternalContent", requestContext, updatedContext -> {
                final String accept = "application/json";
                return service.getExternalContent(this.client.getEndpoint(), cookie, ds, itemId, itemType, accept,
                    updatedContext);
            });
    }
    ...
    public Response<ApiResponseGenshinRoleBasicInfoData> getRoleBasicInfoWithResponse(String cookie, String ds,
        ...
        return this.instrumentation.instrumentWithResponse(
            "UIGF.Mihoyo.Game.Genshin.Record.GameRecordApi.getRoleBasicInfo", requestContext, updatedContext -> {
                final String accept = "application/json";
                return service.getRoleBasicInfo(this.client.getEndpoint(), cookie, ds, roleId, server, accept,
                    updatedContext);
            });
    }
    ...
    public Response<ApiResponseGenshinToolData> getToolWithResponse(String cookie, String ds, String challenge,
        ...
        return this.instrumentation.instrumentWithResponse("UIGF.Mihoyo.Game.Genshin.Record.GameRecordApi.getTool",
            requestContext, updatedContext -> {
                final String accept = "application/json";
                return service.getTool(this.client.getEndpoint(), cookie, ds, challenge, accept, updatedContext);
            });
    }
}
